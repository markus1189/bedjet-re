...
@DebugMetadata(m962c = "androidx.privacysandbox.ads.adservices.java.customaudience.CustomAudienceManagerFutures$Api33Ext4JavaImpl$joinCustomAudienceAsync$1", m963f = "CustomAudienceManagerFutures.kt", m964i = {}, m965l = {113}, m966m = "invokeSuspend", m967n = {}, m968s = {})
...
final class C0491x15d14809 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public C0491x15d14809(CustomAudienceManagerFutures.Api33Ext4JavaImpl api33Ext4JavaImpl, JoinCustomAudienceRequest joinCustomAudienceRequest, Continuation<? super C0491x15d14809> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C0491x15d14809(this.this$0, this.$request, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((C0491x15d14809) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
