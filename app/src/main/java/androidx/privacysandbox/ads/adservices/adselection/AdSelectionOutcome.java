...
public final class AdSelectionOutcome {
    ...
    public int hashCode() {
        return (UByte$$ExternalSyntheticBackport0.m953m(this.adSelectionId) * 31) + this.renderUri.hashCode();
    }
