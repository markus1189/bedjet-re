...
public class FragmentStateManager {
    ...
    int computeExpectedState() {
        ...
        int i2 = C04462.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                i = Math.min(i, 5);
            } else if (i2 == 3) {
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C04462 {
    ...
    public void ensureInflatedView() {
        if (this.mFragment.mFromLayout && this.mFragment.mInLayout && !this.mFragment.mPerformedCreateView) {
            ...
            if (this.mFragment.mView != null) {
                ...
                this.mFragment.mView.setTag(C0410R.id.fragment_container_view_tag, this.mFragment);
                if (this.mFragment.mHidden) {
    ...
    public Bundle saveState() {
        ...
        if (this.mFragment.mState > -1) {
            ...
            Bundle m1259lambda$attachController$4$androidxfragmentappFragmentManager = this.mFragment.mChildFragmentManager.m1259lambda$attachController$4$androidxfragmentappFragmentManager();
            if (!m1259lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
                bundle.putBundle(CHILD_FRAGMENT_MANAGER_KEY, m1259lambda$attachController$4$androidxfragmentappFragmentManager);
            }
            if (this.mFragment.mView != null) {
                saveViewState();
            }
