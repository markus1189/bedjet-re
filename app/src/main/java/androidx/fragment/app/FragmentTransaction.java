...
public abstract class FragmentTransaction {
    ...
    /* loaded from: classes.dex */
    public static final class C0448Op {
        int mCmd;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C0448Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C0448Op(int i, Fragment fragment, boolean z) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        C0448Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
        ...
        C0448Op(C0448Op c0448Op) {
            this.mCmd = c0448Op.mCmd;
            this.mFragment = c0448Op.mFragment;
            this.mFromExpandedOp = c0448Op.mFromExpandedOp;
            this.mEnterAnim = c0448Op.mEnterAnim;
            this.mExitAnim = c0448Op.mExitAnim;
            this.mPopEnterAnim = c0448Op.mPopEnterAnim;
            this.mPopExitAnim = c0448Op.mPopExitAnim;
            this.mOldMaxState = c0448Op.mOldMaxState;
            this.mCurrentMaxState = c0448Op.mCurrentMaxState;
        }
    }
    ...
    public FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction fragmentTransaction) {
        ...
        Iterator<C0448Op> it = fragmentTransaction.mOps.iterator();
        while (it.hasNext()) {
            this.mOps.add(new C0448Op(it.next()));
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void addOp(C0448Op c0448Op) {
        this.mOps.add(c0448Op);
        c0448Op.mEnterAnim = this.mEnterAnim;
        c0448Op.mExitAnim = this.mExitAnim;
        c0448Op.mPopEnterAnim = this.mPopEnterAnim;
        c0448Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0448Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0448Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0448Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0448Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0448Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0448Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0448Op(10, fragment, state));
        return this;
    }
