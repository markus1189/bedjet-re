...
@Metadata(m942d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, m943d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;", "Landroid/graphics/Rect;"}, m944k = 3, m945mv = {1, 8, 0}, m947xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
@DebugMetadata(m962c = "androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1", m963f = "PipHintTracker.kt", m964i = {}, m965l = {85}, m966m = "invokeSuspend", m967n = {}, m968s = {})
        ...
        if (i == 0) {
            ...
            final ?? r3 = new View.OnAttachStateChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$attachStateChangeListener$1
                ...
                public void onViewAttachedToWindow(View v) {
                    ...
                    producerScope2.mo2934trySendJP2dKIU(trackPipAnimationHintView$positionInWindow2);
            ...
            if (Api19Impl.INSTANCE.isAttachedToWindow(this.$view)) {
                ...
                producerScope.mo2934trySendJP2dKIU(trackPipAnimationHintView$positionInWindow);
