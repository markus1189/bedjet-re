...
public final class ActivityResultCallerLauncher<I, O> extends ActivityResultLauncher<Unit> {
    ...
    private final Lazy resultContract = LazyKt.lazy(new Function0<ActivityResultCallerLauncher$resultContract$2.C00251>(this) { // from class: androidx.activity.result.ActivityResultCallerLauncher$resultContract$2
