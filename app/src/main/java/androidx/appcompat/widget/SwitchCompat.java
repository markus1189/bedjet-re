...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SwitchCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            mapBoolean = propertyMapper.mapBoolean("showText", C0030R.attr.showText);
            this.mShowTextId = mapBoolean;
            mapBoolean2 = propertyMapper.mapBoolean("splitTrack", C0030R.attr.splitTrack);
            this.mSplitTrackId = mapBoolean2;
            mapInt = propertyMapper.mapInt("switchMinWidth", C0030R.attr.switchMinWidth);
            this.mSwitchMinWidthId = mapInt;
            mapInt2 = propertyMapper.mapInt("switchPadding", C0030R.attr.switchPadding);
            this.mSwitchPaddingId = mapInt2;
            mapInt3 = propertyMapper.mapInt("thumbTextPadding", C0030R.attr.thumbTextPadding);
            this.mThumbTextPaddingId = mapInt3;
            mapObject4 = propertyMapper.mapObject("thumbTint", C0030R.attr.thumbTint);
            this.mThumbTintId = mapObject4;
            mapObject5 = propertyMapper.mapObject("thumbTintMode", C0030R.attr.thumbTintMode);
            this.mThumbTintModeId = mapObject5;
            mapObject6 = propertyMapper.mapObject("track", C0030R.attr.track);
            this.mTrackId = mapObject6;
            mapObject7 = propertyMapper.mapObject("trackTint", C0030R.attr.trackTint);
            this.mTrackTintId = mapObject7;
            mapObject8 = propertyMapper.mapObject("trackTintMode", C0030R.attr.trackTintMode);
