...
public enum FieldType {
    ...
    static {
        ...
        for (FieldType fieldType : values) {
            VALUES[fieldType.f82id] = fieldType;
        }
    }
    ...
    FieldType(int i, Collection collection, JavaType javaType) {
        ...
        int i3 = C03301.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i3 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i2 = C03301.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : true;
    }
