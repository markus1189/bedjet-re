        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.limit != j4) {
                ...
                if (this.limit - j5 >= 9) {
                    ...
                    if (i2 >= 0) {
                        long j7 = 3 + j4;
                        int i3 = i2 ^ (UnsafeUtil.getByte(j6) << Ascii.f208SO);
                        if (i3 >= 0) {
                            j = i3 ^ 16256;
                            j6 = j7;
                        } else {
            ...
            if (this.currentByteBufferLimit != j) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    ...
                    if (i2 < 0) {
                        ...
                        long j4 = 3 + j;
                        int i3 = (UnsafeUtil.getByte(j3) << Ascii.f208SO) ^ i2;
                        if (i3 >= 0) {
                            i = i3 ^ 16256;
                        } else {
                            long j5 = 4 + j;
                            ...
                            if (i4 < 0) {
                                ...
                                int i5 = (i4 ^ (b2 << Ascii.f201FS)) ^ 266354560;
                                if (b2 < 0) {
                                    j5 = 6 + j;
            ...
            if (this.currentByteBufferLimit != j4) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    ...
                    if (i < 0) {
                        ...
                        long j7 = 3 + j4;
                        int i2 = (UnsafeUtil.getByte(j6) << Ascii.f208SO) ^ i;
                        if (i2 >= 0) {
                            j = i2 ^ 16256;
                            j6 = j7;
                        } else {
