...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        static void setCallback(View view, Callback callback) {
            Object tag = view.getTag(C0170R.id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C0170R.id.tag_window_insets_animation_callback, null);
                if (tag == null) {
            ...
            view.setTag(C0170R.id.tag_window_insets_animation_callback, createProxyListener);
            if (tag == null) {
        ...
        static BoundsCompat computeAnimationBounds(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, int i) {
            ...
            return new BoundsCompat(Insets.m96of(Math.min(insets.left, insets2.left), Math.min(insets.top, insets2.top), Math.min(insets.right, insets2.right), Math.min(insets.bottom, insets2.bottom)), Insets.m96of(Math.max(insets.left, insets2.left), Math.max(insets.top, insets2.top), Math.max(insets.right, insets2.right), Math.max(insets.bottom, insets2.bottom)));
        }
        ...
        static WindowInsets forwardToViewIfNeeded(View view, WindowInsets windowInsets) {
            return view.getTag(C0170R.id.tag_on_apply_window_listener) != null ? windowInsets : view.onApplyWindowInsets(windowInsets);
        }
        ...
        static Callback getCallback(View view) {
            Object tag = view.getTag(C0170R.id.tag_window_insets_animation_callback);
    ...
    public static class Impl30 extends Impl {
        ...
        Impl30(int i, Interpolator interpolator, long j) {
            this(HalfKt$$ExternalSyntheticApiModelOutline0.m242m(i, interpolator, j));
        }
        ...
        public static class ProxyCallback extends WindowInsetsAnimation.Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation m243m = HalfKt$$ExternalSyntheticApiModelOutline0.m243m((Object) list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(m243m);
                    fraction = m243m.getFraction();
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m1239m$1();
            return HalfKt$$ExternalSyntheticApiModelOutline0.m241m(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
