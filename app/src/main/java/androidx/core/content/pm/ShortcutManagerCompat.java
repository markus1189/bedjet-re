...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            isRequestPinShortcutSupported = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).isRequestPinShortcutSupported();
    ...
    public static boolean requestPinShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat, final IntentSender intentSender) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            requestPinShortcut = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
    ...
    public static Intent createShortcutResultIntent(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            intent = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo());
        } else {
            intent = null;
        }
        if (intent == null) {
    ...
    public static List<ShortcutInfoCompat> getShortcuts(Context context, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            systemService2 = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            shortcuts = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService2).getShortcuts(i);
            return ShortcutInfoCompat.fromShortcuts(context, shortcuts);
        }
        if (Build.VERSION.SDK_INT >= 25) {
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            ShortcutManager m139m = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService);
            ArrayList arrayList = new ArrayList();
            if ((i & 1) != 0) {
                manifestShortcuts = m139m.getManifestShortcuts();
                arrayList.addAll(manifestShortcuts);
            }
            if ((i & 2) != 0) {
                dynamicShortcuts = m139m.getDynamicShortcuts();
                arrayList.addAll(dynamicShortcuts);
            }
            if ((i & 4) != 0) {
                pinnedShortcuts = m139m.getPinnedShortcuts();
    ...
    public static boolean addDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            addDynamicShortcuts = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).addDynamicShortcuts(arrayList);
    ...
    public static int getMaxShortcutCountPerActivity(Context context) {
        ...
        systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
        maxShortcutCountPerActivity = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).getMaxShortcutCountPerActivity();
    ...
    public static boolean isRateLimitingActive(Context context) {
        ...
        systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
        isRateLimitingActive = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).isRateLimitingActive();
    ...
    public static int getIconMaxWidth(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            iconMaxWidth = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).getIconMaxWidth();
            return iconMaxWidth;
        }
    ...
    public static int getIconMaxHeight(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            iconMaxHeight = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).getIconMaxHeight();
    ...
    public static void reportShortcutUsed(Context context, String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).reportShortcutUsed(str);
        }
    ...
    public static boolean setDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            dynamicShortcuts = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).setDynamicShortcuts(arrayList);
            if (!dynamicShortcuts) {
                return false;
            }
        }
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            dynamicShortcuts = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).getDynamicShortcuts();
            ArrayList arrayList = new ArrayList(dynamicShortcuts.size());
            Iterator it = dynamicShortcuts.iterator();
            while (it.hasNext()) {
                arrayList.add(new ShortcutInfoCompat.Builder(context, ComponentDialog$$ExternalSyntheticApiModelOutline0.m29m(it.next())).build());
            }
            return arrayList;
        }
        try {
    ...
    public static boolean updateShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            updateShortcuts = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).updateShortcuts(arrayList);
            if (!updateShortcuts) {
                return false;
            }
        }
    ...
    public static void disableShortcuts(Context context, List<String> list, CharSequence charSequence) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).disableShortcuts(list, charSequence);
        }
    ...
    public static void enableShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).enableShortcuts(arrayList);
        }
        getShortcutInfoSaverInstance(context).addShortcuts(removeShortcutsExcludedFromSurface);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static void removeDynamicShortcuts(Context context, List<String> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).removeDynamicShortcuts(list);
        }
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeAllDynamicShortcuts(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).removeAllDynamicShortcuts();
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeLongLivedShortcuts(Context context, List<String> list) {
        ...
        systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
        Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService).removeLongLivedShortcuts(list);
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
            it.next().onShortcutRemoved(list);
    ...
    public static boolean pushDynamicShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            systemService2 = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService2).pushDynamicShortcut(shortcutInfoCompat.toShortcutInfo());
        } else if (Build.VERSION.SDK_INT >= 25) {
            systemService = context.getSystemService((Class<Object>) Profiling$$ExternalSyntheticApiModelOutline0.m161m());
            ShortcutManager m139m = Profiling$$ExternalSyntheticApiModelOutline0.m139m(systemService);
            isRateLimitingActive = m139m.isRateLimitingActive();
            if (isRateLimitingActive) {
                return false;
            }
            dynamicShortcuts = m139m.getDynamicShortcuts();
            if (dynamicShortcuts.size() >= maxShortcutCountPerActivity) {
                m139m.removeDynamicShortcuts(Arrays.asList(Api25Impl.getShortcutInfoWithLowestRank(dynamicShortcuts)));
            }
            m139m.addDynamicShortcuts(Arrays.asList(shortcutInfoCompat.toShortcutInfo()));
        }
