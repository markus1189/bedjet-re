...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(it2.next())));
                }
            }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                if (str.equals(ComponentDialog$$ExternalSyntheticApiModelOutline0.m61m().getName())) {
        ...
        */
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0170R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0170R.id.notification_main_column);
            remoteViews.addView(C0170R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0170R.id.notification_main_column, 0);
            remoteViews.setViewPadding(C0170R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0170R.id.title, 8);
            remoteViews.setViewVisibility(C0170R.id.text2, 8);
            remoteViews.setViewVisibility(C0170R.id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0170R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0170R.dimen.notification_top_pad_large_text);
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && ComponentDialog$$ExternalSyntheticApiModelOutline0.m$1(parcelable)) {
                return IconCompat.createFromIcon(ComponentDialog$$ExternalSyntheticApiModelOutline0.m49m((Object) parcelable));
            }
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                while (it.hasNext()) {
                    Api24Impl.addMessage(ComponentDialog$$ExternalSyntheticApiModelOutline0.m9m((Object) createMessagingStyle), it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        Api26Impl.addHistoricMessage(ComponentDialog$$ExternalSyntheticApiModelOutline0.m9m((Object) createMessagingStyle), it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(ComponentDialog$$ExternalSyntheticApiModelOutline0.m9m((Object) createMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(ComponentDialog$$ExternalSyntheticApiModelOutline0.m9m((Object) createMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            build = Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
    ...
    public static class CallStyle extends Style {
        ...
        protected void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m((Object) bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
            ...
            if (Build.VERSION.SDK_INT >= 23 && bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON)) {
                this.mVerificationIcon = IconCompat.createFromIcon(ComponentDialog$$ExternalSyntheticApiModelOutline0.m49m((Object) bundle.getParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON)));
        ...
        private String getDefaultText() {
            int i = this.mCallType;
            if (i == 1) {
                return this.mBuilder.mContext.getResources().getString(C0170R.string.call_notification_incoming_text);
            }
            if (i == 2) {
                return this.mBuilder.mContext.getResources().getString(C0170R.string.call_notification_ongoing_text);
            }
            if (i != 3) {
                return null;
            }
            return this.mBuilder.mContext.getResources().getString(C0170R.string.call_notification_screening_text);
        }

        private Action makeNegativeAction() {
            int i = C0170R.drawable.ic_call_decline_low;
            int i2 = C0170R.drawable.ic_call_decline;
            if (this.mDeclineIntent == null) {
                return makeAction(i2, C0170R.string.call_notification_hang_up_action, this.mDeclineButtonColor, C0170R.color.call_notification_decline_color, this.mHangUpIntent);
            }
            return makeAction(i2, C0170R.string.call_notification_decline_action, this.mDeclineButtonColor, C0170R.color.call_notification_decline_color, this.mDeclineIntent);
        }

        private Action makeAnswerAction() {
            int i;
            int i2 = C0170R.drawable.ic_call_answer_video_low;
            int i3 = C0170R.drawable.ic_call_answer_low;
            int i4 = C0170R.drawable.ic_call_answer_video;
            int i5 = C0170R.drawable.ic_call_answer;
            ...
            int i6 = z ? i4 : i5;
            if (z) {
                i = C0170R.string.call_notification_answer_video_action;
            } else {
                i = C0170R.string.call_notification_answer_action;
            }
            return makeAction(i6, i, this.mAnswerButtonColor, C0170R.color.call_notification_answer_color, this.mAnswerIntent);
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public static List<CharSequence> getTextsFromContentView(Context context, Notification notification) {
            ...
            if (!ComponentDialog$$ExternalSyntheticApiModelOutline0.m61m().getName().equals(notification.extras.getString(NotificationCompat.EXTRA_TEMPLATE))) {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int min;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0170R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0170R.id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0170R.id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            applyStandardTemplate.setViewVisibility(C0170R.id.actions, i);
            applyStandardTemplate.setViewVisibility(C0170R.id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0170R.layout.notification_action_tombstone;
            } else {
                i = C0170R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0170R.id.action_image, createColoredBitmap(iconCompat, C0170R.color.notification_action_color_filter));
            }
            remoteViews.setTextViewText(C0170R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0170R.id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C0170R.id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m1222clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m1223clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(it.next())));
                }
            }
        } else {
    ...
    public static Bitmap reduceLargeIconSize(Context context, Bitmap bitmap) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0170R.dimen.compat_notification_large_icon_max_width);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C0170R.dimen.compat_notification_large_icon_max_height);
