...
public class KeyPosition extends KeyPositionBase {
    ...
    private static class Loader {
        ...
        static {
            ...
            sAttrMap.append(C0166R.styleable.KeyPosition_framePosition, 2);
            sAttrMap.append(C0166R.styleable.KeyPosition_transitionEasing, 3);
            sAttrMap.append(C0166R.styleable.KeyPosition_curveFit, 4);
            sAttrMap.append(C0166R.styleable.KeyPosition_drawPath, 5);
            sAttrMap.append(C0166R.styleable.KeyPosition_percentX, 6);
            sAttrMap.append(C0166R.styleable.KeyPosition_percentY, 7);
            sAttrMap.append(C0166R.styleable.KeyPosition_keyPositionType, 9);
            sAttrMap.append(C0166R.styleable.KeyPosition_sizePercent, 8);
            sAttrMap.append(C0166R.styleable.KeyPosition_percentWidth, 11);
            sAttrMap.append(C0166R.styleable.KeyPosition_percentHeight, 12);
            sAttrMap.append(C0166R.styleable.KeyPosition_pathMotionArc, 10);
        }
