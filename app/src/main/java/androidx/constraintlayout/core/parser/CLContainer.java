...
public class CLContainer extends CLElement {
    ...
    public CLContainer mo1218clone() {
        CLContainer cLContainer = (CLContainer) super.mo1218clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement mo1218clone = it.next().mo1218clone();
            mo1218clone.setContainer(cLContainer);
