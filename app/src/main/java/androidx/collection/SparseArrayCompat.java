...
public class SparseArrayCompat<E> implements Cloneable {
    ...
    public SparseArrayCompat<E> m1215clone() {
    ...
    public void put(int key, E value) {
        ...
        if (this.garbage && this.size >= this.keys.length) {
            SparseArrayCompatKt.m87gc(this);
    ...
    public void putAll(SparseArrayCompat<? extends E> other) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int binarySearch = ContainerHelpers.binarySearch(this.keys, this.size, keyAt);
            if (binarySearch >= 0) {
                ...
                if (i2 < this.size && this.values[i2] == SparseArrayCompatKt.DELETED) {
                    ...
                    if (this.garbage && this.size >= this.keys.length) {
                        SparseArrayCompatKt.m87gc(this);
                        i2 = ~ContainerHelpers.binarySearch(this.keys, this.size, keyAt);
                    }
                    int i3 = this.size;
