    ...
    */
    public final boolean remove(long r19) {
        /*
            ...
            int r2 = kotlin.UByte$$ExternalSyntheticBackport0.m953m(r19)
    ...
    */
    public final void minusAssign(long r17) {
        /*
            ...
            r1 = r0
            androidx.collection.LongSet r1 = (androidx.collection.LongSet) r1
            int r2 = kotlin.UByte$$ExternalSyntheticBackport0.m953m(r17)
            r3 = -862048943(0xffffffffcc9e2d51, float:-8.293031E7)
            int r2 = r2 * r3
            int r3 = r2 << 16
            r2 = r2 ^ r3
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i2 < i) {
            if (((jArr3[i2 >> 3] >> ((i2 & 7) << 3)) & 255) < 128) {
                long j = jArr4[i2];
                int m953m = UByte$$ExternalSyntheticBackport0.m953m(j) * ScatterMapKt.MurmurHashC1;
                int i3 = m953m ^ (m953m << 16);
    ...
    private final int findAbsoluteInsertIndex(long element) {
        int m953m = UByte$$ExternalSyntheticBackport0.m953m(element) * ScatterMapKt.MurmurHashC1;
        int i = m953m ^ (m953m << 16);
        int i2 = i >>> 7;
        int i3 = i & 127;
