...
public final class ArraySetKt {
    ...
    public static final <E> void clearInternal(ArraySet<E> arraySet) {
        ...
        if (arraySet.get_size$collection() != 0) {
            arraySet.setHashes$collection(ContainerHelpers.EMPTY_INTS);
            arraySet.setArray$collection(ContainerHelpers.EMPTY_OBJECTS);
