...
public final class SparseArrayCompatKt {
    ...
    /* renamed from: gc */
    public static final <E> void m87gc(SparseArrayCompat<E> sparseArrayCompat) {
    ...
    public static final <E> void commonPutAll(SparseArrayCompat<E> sparseArrayCompat, SparseArrayCompat<? extends E> other) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int binarySearch = ContainerHelpers.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, keyAt);
            if (binarySearch >= 0) {
                ...
                if (i2 < sparseArrayCompat.size && sparseArrayCompat.values[i2] == DELETED) {
                    ...
                    if (sparseArrayCompat.garbage && sparseArrayCompat.size >= sparseArrayCompat.keys.length) {
                        m87gc(sparseArrayCompat);
                        i2 = ~ContainerHelpers.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, keyAt);
                    }
                    if (sparseArrayCompat.size >= sparseArrayCompat.keys.length) {
                        int idealIntArraySize = ContainerHelpers.idealIntArraySize(sparseArrayCompat.size + 1);
                        int[] copyOf = Arrays.copyOf(sparseArrayCompat.keys, idealIntArraySize);
    ...
    public static final <E> int commonIndexOfKey(SparseArrayCompat<E> sparseArrayCompat, int i) {
        ...
        return ContainerHelpers.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, i);
    }
