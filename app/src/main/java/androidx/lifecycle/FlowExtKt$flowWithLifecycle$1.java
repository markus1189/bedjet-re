...
@Metadata(m942d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u008a@"}, m943d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/channels/ProducerScope;"}, m944k = 3, m945mv = {1, 8, 0}, m947xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
@DebugMetadata(m962c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1", m963f = "FlowExt.kt", m964i = {0}, m965l = {91}, m966m = "invokeSuspend", m967n = {"$this$callbackFlow"}, m968s = {"L$0"})
...
final class FlowExtKt$flowWithLifecycle$1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: FlowExt.kt */
    @Metadata(m942d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m943d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m944k = 3, m945mv = {1, 8, 0}, m947xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @DebugMetadata(m962c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1$1", m963f = "FlowExt.kt", m964i = {}, m965l = {92}, m966m = "invokeSuspend", m967n = {}, m968s = {})
    ...
    public static final class C04601 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C04601(Flow<? extends T> flow, ProducerScope<? super T> producerScope, Continuation<? super C04601> continuation) {
            super(2, continuation);
            this.$this_flowWithLifecycle = flow;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04601(this.$this_flowWithLifecycle, this.$$this$callbackFlow, continuation);
        }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (RepeatOnLifecycleKt.repeatOnLifecycle(this.$lifecycle, this.$minActiveState, new C04601(this.$this_flowWithLifecycle, producerScope2, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
