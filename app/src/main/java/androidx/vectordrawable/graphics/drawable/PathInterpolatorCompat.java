...
public class PathInterpolatorCompat implements Interpolator {
    ...
    /* renamed from: mX */
    private float[] f120mX;

    /* renamed from: mY */
    private float[] f121mY;
    ...
    private void initPath(Path path) {
        ...
        this.f120mX = new float[min];
        this.f121mY = new float[min];
        ...
        if (Math.abs(this.f120mX[0]) <= 1.0E-5d && Math.abs(this.f121mY[0]) <= 1.0E-5d) {
            int i3 = min - 1;
            if (Math.abs(this.f120mX[i3] - 1.0f) <= 1.0E-5d && Math.abs(this.f121mY[i3] - 1.0f) <= 1.0E-5d) {
                float f = 0.0f;
                int i4 = 0;
                while (i < min) {
                    float[] fArr2 = this.f120mX;
                    int i5 = i4 + 1;
                    float f2 = fArr2[i4];
                    if (f2 < f) {
        ...
        sb.append(this.f120mX[0]);
        sb.append(",");
        sb.append(this.f121mY[0]);
        sb.append(" end:");
        int i6 = min - 1;
        sb.append(this.f120mX[i6]);
        sb.append(",");
        sb.append(this.f121mY[i6]);
