...
public class MathKt__MathJVMKt extends MathH {
    ...
    /* renamed from: ln */
    private static final double m1058ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m1059ln(float f) {
