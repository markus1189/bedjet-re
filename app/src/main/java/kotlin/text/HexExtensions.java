...
public final class HexExtensions {
    ...
    */
    private static final java.lang.String toHexStringSlowPath(byte[] r21, int r22, int r23, kotlin.text.HexFormat.BytesHexFormat r24, int[] r25) {
        ...
        L77:
            if (r1 != r14) goto L7e
            java.lang.String r0 = kotlin.text.StringsKt.concatToString(r15)
            return r0
        L7e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.text.HexExtensions.toHexStringSlowPath(byte[], int, int, kotlin.text.HexFormat$BytesHexFormat, int[]):java.lang.String");
    }
    ...
    private static final int checkFormatLength(long j) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m1643toStringimpl(ULong.m1597constructorimpl(j))));
    }
    ...
    */
    private static final byte[] hexToByteArraySlowPath(java.lang.String r18, int r19, int r20, kotlin.text.HexFormat.BytesHexFormat r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.text.HexExtensions.hexToByteArraySlowPath(java.lang.String, int, int, kotlin.text.HexFormat$BytesHexFormat):byte[]");
    }
    ...
    public static final String toHexString(byte b, HexFormat format) {
        ...
        if (number.getIsDigitsOnlyAndNoPadding()) {
            char[] cArr = {str.charAt((b >> 4) & 15), str.charAt(b & Ascii.f207SI)};
