...
public class DateTimeUtils {
    ...
    public static final Map<String, DateTimeZone> getDefaultTimeZoneNames() {
        ...
        return !LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m284m(atomicReference, null, buildDefaultTimeZoneNames) ? atomicReference.get() : buildDefaultTimeZoneNames;
    }
