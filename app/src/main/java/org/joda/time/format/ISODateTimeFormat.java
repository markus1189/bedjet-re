    ...
    */
    ...
    private static boolean dateByMonth(DateTimeFormatterBuilder dateTimeFormatterBuilder, Collection<DateTimeFieldType> collection, boolean z, boolean z2) {
        if (!collection.remove(DateTimeFieldType.year())) {
            ...
            dateTimeFormatterBuilder.append(Constants.f343ye);
            if (collection.remove(DateTimeFieldType.monthOfYear())) {
                if (collection.remove(DateTimeFieldType.dayOfMonth())) {
                    appendSeparator(dateTimeFormatterBuilder, z);
                    dateTimeFormatterBuilder.appendMonthOfYear(2);
    ...
    private static boolean dateByWeek(DateTimeFormatterBuilder dateTimeFormatterBuilder, Collection<DateTimeFieldType> collection, boolean z, boolean z2) {
        if (!collection.remove(DateTimeFieldType.weekyear())) {
            ...
            dateTimeFormatterBuilder.append(Constants.f341we);
            if (collection.remove(DateTimeFieldType.weekOfWeekyear())) {
                appendSeparator(dateTimeFormatterBuilder, z);
                dateTimeFormatterBuilder.appendLiteral('W');
                dateTimeFormatterBuilder.appendWeekOfWeekyear(2);
    ...
    public static DateTimeFormatter time() {
        return Constants.f337t;
    }

    public static DateTimeFormatter timeNoMillis() {
        return Constants.f340tx;
    }

    public static DateTimeFormatter tTime() {
        return Constants.f339tt;
    }
    ...
    public static DateTimeFormatter basicDate() {
        return Constants.f330bd;
    }

    public static DateTimeFormatter basicTime() {
        return Constants.f331bt;
    }
    ...
    public static DateTimeFormatter year() {
        return Constants.f343ye;
    }

    public static DateTimeFormatter yearMonth() {
        return Constants.f344ym;
    }
    ...
    public static DateTimeFormatter weekyear() {
        return Constants.f341we;
    }

    public static DateTimeFormatter weekyearWeek() {
        return Constants.f342ww;
    }
    ...
    public static final class Constants {
        ...
        /* renamed from: ye */
        private static final DateTimeFormatter f343ye = yearElement();
        private static final DateTimeFormatter mye = monthElement();
        private static final DateTimeFormatter dme = dayOfMonthElement();

        /* renamed from: we */
        private static final DateTimeFormatter f341we = weekyearElement();
        ...
        /* renamed from: ze */
        private static final DateTimeFormatter f345ze = offsetElement();
        private static final DateTimeFormatter lte = literalTElement();

        /* renamed from: ym */
        private static final DateTimeFormatter f344ym = yearMonth();
        private static final DateTimeFormatter ymd = yearMonthDay();

        /* renamed from: ww */
        private static final DateTimeFormatter f342ww = weekyearWeek();
        private static final DateTimeFormatter wwd = weekyearWeekDay();

        /* renamed from: hm */
        private static final DateTimeFormatter f335hm = hourMinute();
        ...
        /* renamed from: dh */
        private static final DateTimeFormatter f332dh = dateHour();
        ...
        /* renamed from: t */
        private static final DateTimeFormatter f337t = time();

        /* renamed from: tx */
        private static final DateTimeFormatter f340tx = timeNoMillis();

        /* renamed from: tt */
        private static final DateTimeFormatter f339tt = tTime();
        private static final DateTimeFormatter ttx = tTimeNoMillis();

        /* renamed from: dt */
        private static final DateTimeFormatter f334dt = dateTime();
        ...
        /* renamed from: od */
        private static final DateTimeFormatter f336od = ordinalDate();
        ...
        /* renamed from: bd */
        private static final DateTimeFormatter f330bd = basicDate();

        /* renamed from: bt */
        private static final DateTimeFormatter f331bt = basicTime();
        ...
        /* renamed from: dp */
        private static final DateTimeFormatter f333dp = dateParser();
        private static final DateTimeFormatter ldp = localDateParser();

        /* renamed from: tp */
        private static final DateTimeFormatter f338tp = timeParser();
        ...
        private static DateTimeFormatter dateParser() {
            DateTimeFormatter dateTimeFormatter = f333dp;
        ...
        private static DateTimeFormatter timeParser() {
            DateTimeFormatter dateTimeFormatter = f338tp;
        ...
        private static DateTimeFormatter time() {
            DateTimeFormatter dateTimeFormatter = f337t;
        ...
        private static DateTimeFormatter timeNoMillis() {
            DateTimeFormatter dateTimeFormatter = f340tx;
        ...
        private static DateTimeFormatter tTime() {
            DateTimeFormatter dateTimeFormatter = f339tt;
        ...
        private static DateTimeFormatter dateTime() {
            DateTimeFormatter dateTimeFormatter = f334dt;
        ...
        private static DateTimeFormatter ordinalDate() {
            DateTimeFormatter dateTimeFormatter = f336od;
        ...
        private static DateTimeFormatter basicDate() {
            DateTimeFormatter dateTimeFormatter = f330bd;
        ...
        private static DateTimeFormatter basicTime() {
            DateTimeFormatter dateTimeFormatter = f331bt;
        ...
        private static DateTimeFormatter yearMonth() {
            DateTimeFormatter dateTimeFormatter = f344ym;
        ...
        private static DateTimeFormatter weekyearWeek() {
            DateTimeFormatter dateTimeFormatter = f342ww;
        ...
        private static DateTimeFormatter hourMinute() {
            DateTimeFormatter dateTimeFormatter = f335hm;
        ...
        private static DateTimeFormatter dateHour() {
            DateTimeFormatter dateTimeFormatter = f332dh;
        ...
        private static DateTimeFormatter yearElement() {
            DateTimeFormatter dateTimeFormatter = f343ye;
        ...
        private static DateTimeFormatter weekyearElement() {
            DateTimeFormatter dateTimeFormatter = f341we;
        ...
        private static DateTimeFormatter offsetElement() {
            DateTimeFormatter dateTimeFormatter = f345ze;
