...
public final class SupervisorKt {
    ...
    public static /* synthetic */ Job m2930SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m2929SupervisorJob(job);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
    /* renamed from: SupervisorJob */
    public static final /* synthetic */ Job m2929SupervisorJob(Job job) {
        return SupervisorJob(job);
    }
    ...
    public static final <R> Object supervisorScope(Function2<? super CoroutineScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        Object startUndispatchedOrReturn = Undispatched.startUndispatchedOrReturn(supervisorCoroutine, supervisorCoroutine, function2);
