...
@DebugMetadata(m962c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", m963f = "Reduce.kt", m964i = {0, 0, 0}, m965l = {179}, m966m = "first", m967n = {"predicate", "result", "collector$iv"}, m968s = {"L$0", "L$1", "L$2"})
