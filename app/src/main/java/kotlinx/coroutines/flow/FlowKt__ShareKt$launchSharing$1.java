...
@DebugMetadata(m962c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1", m963f = "Share.kt", m964i = {}, m965l = {210, 214, 215, 221}, m966m = "invokeSuspend", m967n = {}, m968s = {})
...
public final class FlowKt__ShareKt$launchSharing$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    */
    ...
    @DebugMetadata(m962c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$1", m963f = "Share.kt", m964i = {}, m965l = {}, m966m = "invokeSuspend", m967n = {}, m968s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$1 */
    /* loaded from: classes2.dex */
    public static final class C16021 extends SuspendLambda implements Function2<Integer, Continuation<? super Boolean>, Object> {
        /* synthetic */ int I$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C16021 c16021 = new C16021(continuation);
            c16021.I$0 = ((Number) obj).intValue();
            return c16021;
        }

        public final Object invoke(int i, Continuation<? super Boolean> continuation) {
            return ((C16021) create(Integer.valueOf(i), continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: Share.kt */
    @Metadata(m942d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0015\u0010\u0002\u001a\u00110\u0003¢\u0006\f\b\u0004\u0012\b\b\u0005\u0012\u0004\b\b(\u0006H\n"}, m943d2 = {"<anonymous>", "", "it", "Lkotlinx/coroutines/flow/SharingCommand;", "Lkotlin/ParameterName;", AppMeasurementSdk.ConditionalUserProperty.NAME, "value"}, m944k = 3, m945mv = {2, 0, 0}, m947xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @DebugMetadata(m962c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$2", m963f = "Share.kt", m964i = {}, m965l = {223}, m966m = "invokeSuspend", m967n = {}, m968s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$2 */
    /* loaded from: classes2.dex */
    public static final class C16032 extends SuspendLambda implements Function2<SharingCommand, Continuation<? super Unit>, Object> {
        final /* synthetic */ T $initialValue;
        final /* synthetic */ MutableSharedFlow<T> $shared;
        final /* synthetic */ Flow<T> $upstream;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C16032(Flow<? extends T> flow, MutableSharedFlow<T> mutableSharedFlow, T t, Continuation<? super C16032> continuation) {
            super(2, continuation);
            this.$upstream = flow;
            this.$shared = mutableSharedFlow;
            this.$initialValue = t;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C16032 c16032 = new C16032(this.$upstream, this.$shared, this.$initialValue, continuation);
            c16032.L$0 = obj;
            return c16032;
        }
        ...
        public final Object invoke(SharingCommand sharingCommand, Continuation<? super Unit> continuation) {
            return ((C16032) create(sharingCommand, continuation)).invokeSuspend(Unit.INSTANCE);
        }
