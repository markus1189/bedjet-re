...
public final class ChannelFlowMerge$collectTo$2<T> implements FlowCollector {
    ...
    */
    ...
    @DebugMetadata(m962c = "kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1", m963f = "Merge.kt", m964i = {}, m965l = {65}, m966m = "invokeSuspend", m967n = {}, m968s = {})
    /* renamed from: kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1 */
    /* loaded from: classes2.dex */
    public static final class C16371 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ SendingCollector<T> $collector;
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C16371(Flow<? extends T> flow, SendingCollector<T> sendingCollector, Semaphore semaphore, Continuation<? super C16371> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C16371(this.$inner, this.$collector, this.$semaphore, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C16371) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
