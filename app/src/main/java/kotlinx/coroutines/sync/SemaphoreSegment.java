...
public final class SemaphoreSegment extends Segment<SemaphoreSegment> {
    ...
    public final boolean cas(int index, Object expected, Object value) {
        return C1443xa7a47114.m870m(getAcquirers(), index, expected, value);
    }
