...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2941receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2941receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2942tryReceivePtdJZtk() {
        return this._channel.mo2942tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2934trySendJP2dKIU(E e) {
        return this._channel.mo2934trySendJP2dKIU(e);
    }
