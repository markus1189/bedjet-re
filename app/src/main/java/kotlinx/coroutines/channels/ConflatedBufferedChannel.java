...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m2968trySendImplMj0NB7M = conflatedBufferedChannel.m2968trySendImplMj0NB7M(e, true);
        if (m2968trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2953exceptionOrNullimpl(m2968trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m2968trySendImplMj0NB7M = conflatedBufferedChannel.m2968trySendImplMj0NB7M(e, true);
        if (!(m2968trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2934trySendJP2dKIU(E element) {
        return m2968trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2968trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2967trySendDropLatestMj0NB7M(element, isSendOp) : m2943trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2967trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo2934trySendJP2dKIU = super.mo2934trySendJP2dKIU(element);
        if (ChannelResult.m2959isSuccessimpl(mo2934trySendJP2dKIU) || ChannelResult.m2957isClosedimpl(mo2934trySendJP2dKIU)) {
            return mo2934trySendJP2dKIU;
        }
    ...
    public void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo2934trySendJP2dKIU = mo2934trySendJP2dKIU(element);
        if (!(mo2934trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo2934trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2953exceptionOrNullimpl(mo2934trySendJP2dKIU);
