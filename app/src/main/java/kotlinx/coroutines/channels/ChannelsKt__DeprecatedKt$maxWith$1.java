...
@DebugMetadata(m962c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m963f = "Deprecated.kt", m964i = {0, 0, 0, 1, 1, 1, 1}, m965l = {450, 452}, m966m = "maxWith", m967n = {"comparator", "$this$consume$iv", "iterator", "comparator", "$this$consume$iv", "iterator", "max"}, m968s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$3"})
