...
@DebugMetadata(m962c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$distinctBy$1", m963f = "Deprecated.kt", m964i = {0, 0, 1, 1, 1, 2, 2, 2}, m965l = {417, 418, TypedValues.CycleType.TYPE_EASING}, m966m = "invokeSuspend", m967n = {"$this$produce", UserMetadata.KEYDATA_FILENAME, "$this$produce", UserMetadata.KEYDATA_FILENAME, "e", "$this$produce", UserMetadata.KEYDATA_FILENAME, "k"}, m968s = {"L$0", "L$1", "L$0", "L$1", "L$3", "L$0", "L$1", "L$3"})
