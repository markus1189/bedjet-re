...
public final /* synthetic */ class JobKt__JobKt {
    ...
    public static /* synthetic */ Job m2928Job$default(Job job, int i, Object obj) {
        Job m2927Job;
        if ((i & 1) != 0) {
            job = null;
        }
        m2927Job = m2927Job(job);
        return m2927Job;
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
    /* renamed from: Job */
    public static final /* synthetic */ Job m2927Job(Job job) {
        return JobKt.Job(job);
    }
