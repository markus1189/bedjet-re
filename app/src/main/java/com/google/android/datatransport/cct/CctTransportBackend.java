...
public final class CctTransportBackend implements TransportBackend {
    ...
    private static int getPackageVersionCode(Context context) {
        try {
            ...
            Logging.m529e(LOG_TAG, "Unable to find version code for package", e);
            return -1;
        }
    }
    ...
    private BatchedLogRequest getRequestBody(BackendRequest backendRequest) {
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            ...
            for (EventInternal eventInternal3 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.m523of("proto"))) {
                    protoBuilder = LogEvent.protoBuilder(encodedPayload.getBytes());
                } else if (encoding.equals(Encoding.m523of("json"))) {
                    protoBuilder = LogEvent.jsonBuilder(new String(encodedPayload.getBytes(), Charset.forName("UTF-8")));
                } else {
                    Logging.m531w(LOG_TAG, "Received event of unsupported encoding %s. Skipping...", encoding);
                }
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        Logging.m530i(LOG_TAG, "Making request to: %s", httpRequest.url);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Logging.m530i(LOG_TAG, "Status Code: %d", Integer.valueOf(responseCode));
                    Logging.m526d(LOG_TAG, "Content-Type: %s", httpURLConnection.getHeaderField("Content-Type"));
                    Logging.m526d(LOG_TAG, "Content-Encoding: %s", httpURLConnection.getHeaderField("Content-Encoding"));
            ...
            e = e;
            Logging.m529e(LOG_TAG, "Couldn't encode request, returning with 400", e);
            return new HttpResponse(400, null, 0L);
        } catch (ConnectException e2) {
            e = e2;
            Logging.m529e(LOG_TAG, "Couldn't open connection, returning with 500", e);
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            ...
            if (httpResponse.code == 200) {
                return BackendResponse.m524ok(httpResponse.nextRequestMillis);
            }
            ...
            Logging.m529e(LOG_TAG, "Could not make request to the backend", e);
            return BackendResponse.transientError();
        }
    }
    ...
    public static /* synthetic */ HttpRequest lambda$send$0(HttpRequest httpRequest, HttpResponse httpResponse) {
        ...
        Logging.m526d(LOG_TAG, "Following redirect to: %s", httpResponse.redirectUrl);
