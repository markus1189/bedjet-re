...
public final class GoogleServices {
    ...
    GoogleServices(Context context) {
        ...
        int identifier = resources.getIdentifier("google_app_measurement_enable", TypedValues.Custom.S_INT, resources.getResourcePackageName(C0668R.string.common_google_play_services_unknown_issue));
        if (identifier != 0) {
