...
import com.google.android.gms.base.C0667R;
...
public final class zac {
    ...
    public static String zab(Context context, int i) {
        ...
        if (i == 1) {
            return resources.getString(C0667R.string.common_google_play_services_install_button);
        }
        if (i == 2) {
            return resources.getString(C0667R.string.common_google_play_services_update_button);
        }
        if (i == 3) {
            return resources.getString(C0667R.string.common_google_play_services_enable_button);
        }
    ...
    public static String zac(Context context, int i) {
        ...
        if (i == 1) {
            return resources.getString(C0667R.string.common_google_play_services_install_text, zaa2);
        }
        if (i == 2) {
            return DeviceProperties.isWearableWithoutPlayStore(context) ? resources.getString(C0667R.string.common_google_play_services_wear_update_text) : resources.getString(C0667R.string.common_google_play_services_update_text, zaa2);
        }
        if (i == 3) {
            return resources.getString(C0667R.string.common_google_play_services_enable_text, zaa2);
        }
        if (i == 5) {
        ...
        if (i == 9) {
            return resources.getString(C0667R.string.common_google_play_services_unsupported_text, zaa2);
        }
        if (i == 20) {
        ...
        switch (i) {
            ...
            case 18:
                return resources.getString(C0667R.string.common_google_play_services_updating_text, zaa2);
            default:
                return resources.getString(C0668R.string.common_google_play_services_unknown_issue, zaa2);
        }
    }
    ...
    public static String zae(Context context, int i) {
        ...
        return zaf == null ? context.getResources().getString(C0667R.string.common_google_play_services_notification_ticker) : zaf;
    }
    ...
    public static String zaf(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0667R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C0667R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C0667R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    private static String zag(Context context, String str, String str2) {
        ...
        if (zah == null) {
            zah = resources.getString(C0668R.string.common_google_play_services_unknown_issue);
        }
