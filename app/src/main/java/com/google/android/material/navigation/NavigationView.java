...
public class NavigationView extends ScrimInsetsFrameLayout implements MaterialBackHandler {
    ...
    private static final int DEF_STYLE_RES = C0675R.style.Widget_Design_NavigationView;
    ...
    public NavigationView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0675R.attr.navigationViewStyle);
    }
    ...
    */
    ...
    private boolean hasShapeAppearance(TintTypedArray tintTypedArray) {
        return tintTypedArray.hasValue(C0675R.styleable.NavigationView_itemShapeAppearance) || tintTypedArray.hasValue(C0675R.styleable.NavigationView_itemShapeAppearanceOverlay);
    }
    ...
    private Drawable createDefaultItemBackground(TintTypedArray tintTypedArray) {
        return createDefaultItemDrawable(tintTypedArray, MaterialResources.getColorStateList(getContext(), tintTypedArray, C0675R.styleable.NavigationView_itemShapeFillColor));
    }

    private Drawable createDefaultItemDrawable(TintTypedArray tintTypedArray, ColorStateList colorStateList) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(ShapeAppearanceModel.builder(getContext(), tintTypedArray.getResourceId(C0675R.styleable.NavigationView_itemShapeAppearance, 0), tintTypedArray.getResourceId(C0675R.styleable.NavigationView_itemShapeAppearanceOverlay, 0)).build());
        materialShapeDrawable.setFillColor(colorStateList);
        return new InsetDrawable((Drawable) materialShapeDrawable, tintTypedArray.getDimensionPixelSize(C0675R.styleable.NavigationView_itemShapeInsetStart, 0), tintTypedArray.getDimensionPixelSize(C0675R.styleable.NavigationView_itemShapeInsetTop, 0), tintTypedArray.getDimensionPixelSize(C0675R.styleable.NavigationView_itemShapeInsetEnd, 0), tintTypedArray.getDimensionPixelSize(C0675R.styleable.NavigationView_itemShapeInsetBottom, 0));
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        this.shapeableDelegate.maybeClip(canvas, new CanvasCompat.CanvasOperation() { // from class: com.google.android.material.navigation.NavigationView$$ExternalSyntheticLambda0
            ...
            public final void run(Canvas canvas2) {
                NavigationView.this.m642xb790515(canvas2);
            }
        });
    }
    ...
    public /* synthetic */ void m642xb790515(Canvas canvas) {
