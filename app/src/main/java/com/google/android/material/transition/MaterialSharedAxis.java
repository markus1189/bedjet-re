...
public final class MaterialSharedAxis extends MaterialVisibility<VisibilityAnimatorProvider> {
    private static final int DEFAULT_THEMED_DURATION_ATTR = C0675R.attr.motionDurationLong1;
    private static final int DEFAULT_THEMED_EASING_ATTR = C0675R.attr.motionEasingEmphasizedInterpolator;

    /* renamed from: X */
    public static final int f190X = 0;

    /* renamed from: Y */
    public static final int f191Y = 1;

    /* renamed from: Z */
    public static final int f192Z = 2;
