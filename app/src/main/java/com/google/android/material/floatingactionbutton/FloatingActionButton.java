...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C0675R.style.Widget_Design_FloatingActionButton;
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0675R.attr.floatingActionButtonStyle);
    }
    ...
    */
    ...
    private int getSizeDimension(int i) {
        ...
        if (i != -1) {
            if (i == 1) {
                return resources.getDimensionPixelSize(C0675R.dimen.design_fab_size_mini);
            }
            return resources.getDimensionPixelSize(C0675R.dimen.design_fab_size_normal);
        }
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0675R.styleable.FloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = obtainStyledAttributes.getBoolean(C0675R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
