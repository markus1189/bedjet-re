...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    private static final int DEF_STYLE_ATTR = C0675R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C0675R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C0675R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C0675R.attr.colorSurface, getClass().getCanonicalName());
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(null, C0675R.styleable.MaterialAlertDialog, i2, i3);
        int color2 = obtainStyledAttributes.getColor(C0675R.styleable.MaterialAlertDialog_backgroundTint, color);
