...
public class MaterialColors {
    ...
    public static int harmonizeWithPrimary(Context context, int i) {
        return harmonize(i, getColor(context, C0675R.attr.colorPrimary, MaterialColors.class.getCanonicalName()));
    }
    ...
    public static boolean isLightTheme(Context context) {
        return MaterialAttributes.resolveBoolean(context, C0675R.attr.isLightTheme, true);
    }
