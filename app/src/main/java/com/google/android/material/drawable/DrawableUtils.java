...
public final class DrawableUtils {
    ...
    public static ColorStateList getColorStateListOrNull(Drawable drawable) {
        ...
        if (Build.VERSION.SDK_INT < 29 || !Transition$Impl26$$ExternalSyntheticApiModelOutline0.m511m((Object) drawable)) {
            return null;
        }
        colorStateList = Transition$Impl26$$ExternalSyntheticApiModelOutline0.m443m((Object) drawable).getColorStateList();
