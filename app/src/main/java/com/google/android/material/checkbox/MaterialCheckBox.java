...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static final int DEF_STYLE_RES = C0675R.style.Widget_MaterialComponents_CompoundButton_CheckBox;
    private static final int[] INDETERMINATE_STATE_SET = {C0675R.attr.state_indeterminate};
    private static final int[] ERROR_STATE_SET = {C0675R.attr.state_error};
    private static final int[][] CHECKBOX_STATES = {new int[]{R.attr.state_enabled, C0675R.attr.state_error}, new int[]{R.attr.state_enabled, R.attr.state_checked}, new int[]{R.attr.state_enabled, -16842912}, new int[]{-16842910, R.attr.state_checked}, new int[]{-16842910, -16842912}};
    ...
    public MaterialCheckBox(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0675R.attr.checkboxStyle);
    }
    ...
    */
    public MaterialCheckBox(android.content.Context r9, android.util.AttributeSet r10, int r11) {
        /*
            ...
            int r0 = com.google.android.material.C0675R.drawable.mtrl_checkbox_button_checked_unchecked
            ...
            int[] r2 = com.google.android.material.C0675R.styleable.MaterialCheckBox
            r7 = 0
            int[] r5 = new int[r7]
            r0 = r9
            r1 = r10
            ...
            int r11 = com.google.android.material.C0675R.styleable.MaterialCheckBox_buttonIcon
            ...
            int r11 = com.google.android.material.C0675R.drawable.mtrl_checkbox_button
            ...
            if (r11 != 0) goto L7c
            int r11 = com.google.android.material.C0675R.drawable.mtrl_checkbox_button_icon
            android.graphics.drawable.Drawable r11 = androidx.appcompat.content.res.AppCompatResources.getDrawable(r9, r11)
            r8.buttonIconDrawable = r11
        L7c:
            int r11 = com.google.android.material.C0675R.styleable.MaterialCheckBox_buttonIconTint
            ...
            int r9 = com.google.android.material.C0675R.styleable.MaterialCheckBox_buttonIconTintMode
            r11 = -1
            ...
            int r9 = com.google.android.material.C0675R.styleable.MaterialCheckBox_useMaterialThemeColors
            boolean r9 = r10.getBoolean(r9, r7)
            r8.useMaterialThemeColors = r9
            int r9 = com.google.android.material.C0675R.styleable.MaterialCheckBox_centerIfNoTextEnabled
            boolean r9 = r10.getBoolean(r9, r0)
            r8.centerIfNoTextEnabled = r9
            int r9 = com.google.android.material.C0675R.styleable.MaterialCheckBox_errorShown
            boolean r9 = r10.getBoolean(r9, r7)
            r8.errorShown = r9
            int r9 = com.google.android.material.C0675R.styleable.MaterialCheckBox_errorAccessibilityLabel
            java.lang.CharSequence r9 = r10.getText(r9)
            r8.errorAccessibilityLabel = r9
            int r9 = com.google.android.material.C0675R.styleable.MaterialCheckBox_checkedState
    ...
    public /* synthetic */ void m594xdf87d0bf() {
    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                systemService = getContext().getSystemService((Class<Object>) Transition$Impl26$$ExternalSyntheticApiModelOutline0.m464m());
                AutofillManager m459m = Transition$Impl26$$ExternalSyntheticApiModelOutline0.m459m(systemService);
                if (m459m != null) {
                    m459m.notifyValueChanged(this);
                }
            }
    ...
    private void setUpDefaultButtonDrawableAnimationIfNeeded() {
        if (this.usingMaterialButtonDrawable) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                ((AnimatedStateListDrawable) drawable).addTransition(C0675R.id.checked, C0675R.id.unchecked, this.transitionToUnchecked, false);
                ((AnimatedStateListDrawable) this.buttonDrawable).addTransition(C0675R.id.indeterminate, C0675R.id.unchecked, this.transitionToUnchecked, false);
            }
        }
    }
    ...
    private String getButtonStateDescription() {
        ...
        if (i == 1) {
            return getResources().getString(C0675R.string.mtrl_checkbox_state_description_checked);
        }
        if (i == 0) {
            return getResources().getString(C0675R.string.mtrl_checkbox_state_description_unchecked);
        }
        return getResources().getString(C0675R.string.mtrl_checkbox_state_description_indeterminate);
    }
    ...
    private boolean isButtonDrawableLegacy(TintTypedArray tintTypedArray) {
        return tintTypedArray.getResourceId(C0675R.styleable.MaterialCheckBox_android_button, 0) == FRAMEWORK_BUTTON_DRAWABLE_RES_ID && tintTypedArray.getResourceId(C0675R.styleable.MaterialCheckBox_buttonCompat, 0) == 0;
    }
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            ...
            int color = MaterialColors.getColor(this, C0675R.attr.colorControlActivated);
            int color2 = MaterialColors.getColor(this, C0675R.attr.colorError);
            int color3 = MaterialColors.getColor(this, C0675R.attr.colorSurface);
            int color4 = MaterialColors.getColor(this, C0675R.attr.colorOnSurface);
