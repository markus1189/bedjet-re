...
public final class HarmonizedColorAttributes {
    private static final int[] HARMONIZED_MATERIAL_ATTRIBUTES = {C0675R.attr.colorError, C0675R.attr.colorOnError, C0675R.attr.colorErrorContainer, C0675R.attr.colorOnErrorContainer};
    ...
    public static HarmonizedColorAttributes createMaterialDefaults() {
        return create(HARMONIZED_MATERIAL_ATTRIBUTES, C0675R.style.ThemeOverlay_Material3_HarmonizedColors);
    }
