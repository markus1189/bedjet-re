...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            i = C0675R.layout.mtrl_calendar_vertical;
            i2 = 1;
        } else {
            i = C0675R.layout.mtrl_calendar_horizontal;
            i2 = 0;
        }
        View inflate = cloneInContext.inflate(i, viewGroup, false);
        inflate.setMinimumHeight(getDialogPickerHeight(requireContext()));
        GridView gridView = (GridView) inflate.findViewById(C0675R.id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) inflate.findViewById(C0675R.id.mtrl_calendar_months);
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C0675R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView = (RecyclerView) inflate.findViewById(C0675R.id.mtrl_calendar_year_selector_frame);
        ...
        if (inflate.findViewById(C0675R.id.month_navigation_fragment_toggle) != null) {
    ...
    public static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C0675R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButton = (MaterialButton) view.findViewById(C0675R.id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(materialButton, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
            ...
            public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    string = MaterialCalendar.this.getString(C0675R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    string = MaterialCalendar.this.getString(C0675R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.setHintText(string);
            }
        });
        View findViewById = view.findViewById(C0675R.id.month_navigation_previous);
        this.monthPrev = findViewById;
        findViewById.setTag(NAVIGATION_PREV_TAG);
        View findViewById2 = view.findViewById(C0675R.id.month_navigation_next);
        this.monthNext = findViewById2;
        findViewById2.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(C0675R.id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C0675R.id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        return resources.getDimensionPixelSize(C0675R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C0675R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C0675R.dimen.mtrl_calendar_navigation_bottom_padding) + resources.getDimensionPixelSize(C0675R.dimen.mtrl_calendar_days_of_week_height) + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C0675R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C0675R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C0675R.dimen.mtrl_calendar_bottom_padding);
    }
