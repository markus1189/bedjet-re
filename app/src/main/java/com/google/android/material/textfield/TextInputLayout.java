...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private static final int DEF_STYLE_RES = C0675R.style.Widget_Design_TextInputLayout;
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0675R.attr.textInputStyle);
    }
    ...
    */
        ...
        if (updateEditTextHeightBasedOnIcon || updateDummyDrawables) {
            this.editText.post(new Runnable() { // from class: com.google.android.material.textfield.TextInputLayout$$ExternalSyntheticLambda10
                ...
                public final void run() {
                    TextInputLayout.this.m674xa47602b9();
                }
            });
        }
    }
    ...
    public /* synthetic */ void m674xa47602b9() {
    ...
    private Drawable getEditTextBoxBackground() {
        ...
        int color = MaterialColors.getColor(this.editText, C0675R.attr.colorControlHighlight);
        int i = this.boxBackgroundMode;
        if (i == 2) {
    ...
    private static Drawable getOutlinedBoxBackgroundWithRipple(Context context, MaterialShapeDrawable materialShapeDrawable, int i, int[][] iArr) {
        int color = MaterialColors.getColor(context, C0675R.attr.colorSurface, LOG_TAG);
    ...
    private MaterialShapeDrawable getDropDownMaterialShapeDrawable(boolean z) {
        ...
        float dimensionPixelOffset2 = getResources().getDimensionPixelOffset(C0675R.dimen.mtrl_shape_corner_size_small_component);
        ...
        if (editText instanceof MaterialAutoCompleteTextView) {
            ...
            dimensionPixelOffset = getResources().getDimensionPixelOffset(C0675R.dimen.m3_comp_outlined_autocomplete_menu_container_elevation);
        }
        int dimensionPixelOffset3 = getResources().getDimensionPixelOffset(C0675R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
    ...
    private void updateBoxCollapsedPaddingTop() {
        if (this.boxBackgroundMode == 1) {
            if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C0675R.dimen.material_font_2_0_box_collapsed_padding_top);
            } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C0675R.dimen.material_font_1_3_box_collapsed_padding_top);
            }
        }
    }
    ...
    private void adjustFilledEditTextPaddingForLargeFont() {
        ...
        if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
            EditText editText = this.editText;
            ViewCompat.setPaddingRelative(editText, ViewCompat.getPaddingStart(editText), getResources().getDimensionPixelSize(C0675R.dimen.material_filled_edittext_font_2_0_padding_top), ViewCompat.getPaddingEnd(this.editText), getResources().getDimensionPixelSize(C0675R.dimen.material_filled_edittext_font_2_0_padding_bottom));
        } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
            EditText editText2 = this.editText;
            ViewCompat.setPaddingRelative(editText2, ViewCompat.getPaddingStart(editText2), getResources().getDimensionPixelSize(C0675R.dimen.material_filled_edittext_font_1_3_padding_top), ViewCompat.getPaddingEnd(this.editText), getResources().getDimensionPixelSize(C0675R.dimen.material_filled_edittext_font_1_3_padding_bottom));
        }
    }
    ...
    public void setCounterEnabled(boolean z) {
        if (this.counterEnabled != z) {
            if (z) {
                ...
                appCompatTextView.setId(C0675R.id.textinput_counter);
                ...
                MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) this.counterView.getLayoutParams(), getResources().getDimensionPixelOffset(C0675R.dimen.mtrl_textinput_counter_margin_start));
    ...
    void updateCounter(Editable editable) {
        ...
        if (i == -1) {
            ...
            this.counterView.setText(BidiFormatter.getInstance().unicodeWrap(getContext().getString(C0675R.string.character_counter_pattern, Integer.valueOf(countLength), Integer.valueOf(this.counterMaxLength))));
        }
    ...
    private static void updateCounterContentDescription(Context context, TextView textView, int i, int i2, boolean z) {
        int i3;
        if (z) {
            i3 = C0675R.string.character_counter_overflowed_content_description;
        } else {
            i3 = C0675R.string.character_counter_content_description;
        }
    ...
    public void setPlaceholderText(CharSequence charSequence) {
        if (this.placeholderTextView == null) {
            ...
            appCompatTextView.setId(C0675R.id.textinput_placeholder);
    ...
    private Fade createPlaceholderFadeTransition() {
        Fade fade = new Fade();
        fade.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0675R.attr.motionDurationShort2, DEFAULT_PLACEHOLDER_FADE_DURATION));
        fade.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0675R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR));
        return fade;
    }
    ...
    public void setTextAppearanceCompatWithErrorFallback(TextView textView, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            TextViewCompat.setTextAppearance(textView, C0675R.style.TextAppearance_AppCompat_Caption);
            textView.setTextColor(ContextCompat.getColor(getContext(), C0675R.color.design_error));
        }
    }
    ...
    private int calculateBoxBackgroundColor() {
        return this.boxBackgroundMode == 1 ? MaterialColors.layer(MaterialColors.getColor(this, C0675R.attr.colorSurface, 0), this.boxBackgroundColor) : this.boxBackgroundColor;
    }
    ...
    private void updateCursorColor() {
        ...
        if (colorStateList2 == null) {
            colorStateList2 = MaterialColors.getColorStateListOrNull(getContext(), C0675R.attr.colorControlActivated);
        }
        EditText editText = this.editText;
        if (editText != null) {
    ...
    void animateToExpansionFraction(float f) {
        ...
        if (this.animator == null) {
            ...
            valueAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0675R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
            this.animator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0675R.attr.motionDurationMedium4, LABEL_SCALE_ANIMATION_DURATION));
