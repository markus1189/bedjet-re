...
public class AnalyticsDeferredProxy {
    ...
    public BreadcrumbSource getDeferredBreadcrumbSource() {
        return new BreadcrumbSource() { // from class: com.google.firebase.crashlytics.AnalyticsDeferredProxy$$ExternalSyntheticLambda0
            ...
            public final void registerBreadcrumbHandler(BreadcrumbHandler breadcrumbHandler) {
                AnalyticsDeferredProxy.this.m888x77abb2bd(breadcrumbHandler);
            }
        };
    }
    ...
    public /* synthetic */ void m888x77abb2bd(BreadcrumbHandler breadcrumbHandler) {
        synchronized (this) {
    ...
    public AnalyticsEventLogger getAnalyticsEventLogger() {
        return new AnalyticsEventLogger() { // from class: com.google.firebase.crashlytics.AnalyticsDeferredProxy$$ExternalSyntheticLambda1
            ...
            public final void logEvent(String str, Bundle bundle) {
                AnalyticsDeferredProxy.this.m887xdd1a3d95(str, bundle);
            }
        };
    }
    ...
    public /* synthetic */ void m887xdd1a3d95(String str, Bundle bundle) {
    ...
    private void init() {
        this.analyticsConnectorDeferred.whenAvailable(new Deferred.DeferredHandler() { // from class: com.google.firebase.crashlytics.AnalyticsDeferredProxy$$ExternalSyntheticLambda2
            ...
            public final void handle(Provider provider) {
                AnalyticsDeferredProxy.this.m889xec284ea4(provider);
            }
        });
    }
    ...
    public /* synthetic */ void m889xec284ea4(Provider provider) {
        Logger.getLogger().m891d("AnalyticsConnector now available.");
        ...
        if (subscribeToAnalyticsEvents(analyticsConnector, crashlyticsAnalyticsListener) != null) {
            Logger.getLogger().m891d("Registered Firebase Analytics listener.");
        ...
        Logger.getLogger().m899w("Could not register Firebase Analytics listener; a listener is already registered.");
    }
    ...
    private static AnalyticsConnector.AnalyticsConnectorHandle subscribeToAnalyticsEvents(AnalyticsConnector analyticsConnector, CrashlyticsAnalyticsListener crashlyticsAnalyticsListener) {
        ...
        if (registerAnalyticsConnectorListener == null) {
            Logger.getLogger().m891d("Could not register AnalyticsConnectorListener with Crashlytics origin.");
            ...
            if (registerAnalyticsConnectorListener != null) {
                Logger.getLogger().m899w("A new version of the Google Analytics for Firebase SDK is now available. For improved performance and compatibility with Crashlytics, please update to the latest version.");
            }
        }
