...
final class C1506x87204092 extends CrashlyticsReport.Session.Event.RolloutAssignment.RolloutVariant {
    private final String rolloutId;
    private final String variantId;

    private C1506x87204092(String str, String str2) {
        this.rolloutId = str;
        this.variantId = str2;
    }
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.RolloutAssignment.RolloutVariant.Builder {
        ...
        public CrashlyticsReport.Session.Event.RolloutAssignment.RolloutVariant build() {
            ...
            return new C1506x87204092(str2, str);
        }
    }
}
