...
final class C1498xc2f5febc extends CrashlyticsReport.Session.Event.Application.Execution.Exception {
    ...
    private C1498xc2f5febc(String str, String str2, List<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> list, CrashlyticsReport.Session.Event.Application.Execution.Exception exception, int i) {
        this.type = str;
        this.reason = str2;
        this.frames = list;
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Exception.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Exception build() {
            ...
            return new C1498xc2f5febc(str, this.reason, list, this.causedBy, this.overflowCount);
        }
    }
}
