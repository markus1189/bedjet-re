...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        ...
        encoderConfig.registerEncoder(C1500x7e3e3ebd.class, CrashlyticsReportSessionEventApplicationExecutionThreadEncoder.INSTANCE);
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.class, C1482xc3999712.INSTANCE);
        encoderConfig.registerEncoder(C1501xce3d994b.class, C1482xc3999712.INSTANCE);
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.Application.Execution.Exception.class, C1481x55689506.INSTANCE);
        encoderConfig.registerEncoder(C1498xc2f5febc.class, C1481x55689506.INSTANCE);
        ...
        encoderConfig.registerEncoder(C1486xb26d2aa8.class, CrashlyticsReportApplicationExitInfoBuildIdMappingForArchEncoder.INSTANCE);
        ...
        encoderConfig.registerEncoder(C1499x7c929f5b.class, CrashlyticsReportSessionEventApplicationExecutionSignalEncoder.INSTANCE);
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.class, C1480x99c932db.INSTANCE);
        encoderConfig.registerEncoder(C1497xfe724d07.class, C1480x99c932db.INSTANCE);
        ...
        encoderConfig.registerEncoder(C1502x94fa915f.class, CrashlyticsReportSessionEventApplicationProcessDetailsEncoder.INSTANCE);
        ...
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.RolloutAssignment.RolloutVariant.class, C1483x319e1f5b.INSTANCE);
        encoderConfig.registerEncoder(C1506x87204092.class, C1483x319e1f5b.INSTANCE);
    ...
    private static final class CrashlyticsReportEncoder implements ObjectEncoder<CrashlyticsReport> {
        ...
        private static final FieldDescriptor SDKVERSION_DESCRIPTOR = FieldDescriptor.m920of(RemoteConfigConstants.RequestFieldKey.SDK_VERSION);
        private static final FieldDescriptor GMPAPPID_DESCRIPTOR = FieldDescriptor.m920of("gmpAppId");
        private static final FieldDescriptor PLATFORM_DESCRIPTOR = FieldDescriptor.m920of("platform");
        private static final FieldDescriptor INSTALLATIONUUID_DESCRIPTOR = FieldDescriptor.m920of("installationUuid");
        ...
        private static final FieldDescriptor APPQUALITYSESSIONID_DESCRIPTOR = FieldDescriptor.m920of("appQualitySessionId");
        private static final FieldDescriptor BUILDVERSION_DESCRIPTOR = FieldDescriptor.m920of("buildVersion");
        private static final FieldDescriptor DISPLAYVERSION_DESCRIPTOR = FieldDescriptor.m920of("displayVersion");
        private static final FieldDescriptor SESSION_DESCRIPTOR = FieldDescriptor.m920of("session");
        private static final FieldDescriptor NDKPAYLOAD_DESCRIPTOR = FieldDescriptor.m920of("ndkPayload");
        private static final FieldDescriptor APPEXITINFO_DESCRIPTOR = FieldDescriptor.m920of("appExitInfo");
    ...
    private static final class CrashlyticsReportSessionEncoder implements ObjectEncoder<CrashlyticsReport.Session> {
        ...
        private static final FieldDescriptor GENERATOR_DESCRIPTOR = FieldDescriptor.m920of("generator");
        private static final FieldDescriptor IDENTIFIER_DESCRIPTOR = FieldDescriptor.m920of("identifier");
        private static final FieldDescriptor APPQUALITYSESSIONID_DESCRIPTOR = FieldDescriptor.m920of("appQualitySessionId");
        private static final FieldDescriptor STARTEDAT_DESCRIPTOR = FieldDescriptor.m920of("startedAt");
        private static final FieldDescriptor ENDEDAT_DESCRIPTOR = FieldDescriptor.m920of("endedAt");
        private static final FieldDescriptor CRASHED_DESCRIPTOR = FieldDescriptor.m920of("crashed");
        private static final FieldDescriptor APP_DESCRIPTOR = FieldDescriptor.m920of("app");
        private static final FieldDescriptor USER_DESCRIPTOR = FieldDescriptor.m920of("user");
        private static final FieldDescriptor OS_DESCRIPTOR = FieldDescriptor.m920of("os");
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.m920of("device");
        private static final FieldDescriptor EVENTS_DESCRIPTOR = FieldDescriptor.m920of("events");
        private static final FieldDescriptor GENERATORTYPE_DESCRIPTOR = FieldDescriptor.m920of("generatorType");
    ...
    private static final class CrashlyticsReportSessionApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application> {
        ...
        private static final FieldDescriptor IDENTIFIER_DESCRIPTOR = FieldDescriptor.m920of("identifier");
        private static final FieldDescriptor VERSION_DESCRIPTOR = FieldDescriptor.m920of("version");
        private static final FieldDescriptor DISPLAYVERSION_DESCRIPTOR = FieldDescriptor.m920of("displayVersion");
        private static final FieldDescriptor ORGANIZATION_DESCRIPTOR = FieldDescriptor.m920of("organization");
        private static final FieldDescriptor INSTALLATIONUUID_DESCRIPTOR = FieldDescriptor.m920of("installationUuid");
        private static final FieldDescriptor DEVELOPMENTPLATFORM_DESCRIPTOR = FieldDescriptor.m920of("developmentPlatform");
        private static final FieldDescriptor DEVELOPMENTPLATFORMVERSION_DESCRIPTOR = FieldDescriptor.m920of("developmentPlatformVersion");
    ...
    private static final class CrashlyticsReportSessionApplicationOrganizationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application.Organization> {
        ...
        private static final FieldDescriptor CLSID_DESCRIPTOR = FieldDescriptor.m920of("clsId");
    ...
    private static final class CrashlyticsReportSessionOperatingSystemEncoder implements ObjectEncoder<CrashlyticsReport.Session.OperatingSystem> {
        ...
        private static final FieldDescriptor VERSION_DESCRIPTOR = FieldDescriptor.m920of("version");
        private static final FieldDescriptor BUILDVERSION_DESCRIPTOR = FieldDescriptor.m920of("buildVersion");
        private static final FieldDescriptor JAILBROKEN_DESCRIPTOR = FieldDescriptor.m920of("jailbroken");
    ...
    private static final class CrashlyticsReportSessionDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Device> {
        ...
        private static final FieldDescriptor ARCH_DESCRIPTOR = FieldDescriptor.m920of("arch");
        private static final FieldDescriptor MODEL_DESCRIPTOR = FieldDescriptor.m920of("model");
        private static final FieldDescriptor CORES_DESCRIPTOR = FieldDescriptor.m920of("cores");
        private static final FieldDescriptor RAM_DESCRIPTOR = FieldDescriptor.m920of("ram");
        private static final FieldDescriptor DISKSPACE_DESCRIPTOR = FieldDescriptor.m920of("diskSpace");
        private static final FieldDescriptor SIMULATOR_DESCRIPTOR = FieldDescriptor.m920of("simulator");
        private static final FieldDescriptor STATE_DESCRIPTOR = FieldDescriptor.m920of(RemoteConfigConstants.ResponseFieldKey.STATE);
        private static final FieldDescriptor MANUFACTURER_DESCRIPTOR = FieldDescriptor.m920of("manufacturer");
        private static final FieldDescriptor MODELCLASS_DESCRIPTOR = FieldDescriptor.m920of("modelClass");
    ...
    private static final class CrashlyticsReportSessionEventEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event> {
        ...
        private static final FieldDescriptor TIMESTAMP_DESCRIPTOR = FieldDescriptor.m920of("timestamp");
        private static final FieldDescriptor TYPE_DESCRIPTOR = FieldDescriptor.m920of("type");
        private static final FieldDescriptor APP_DESCRIPTOR = FieldDescriptor.m920of("app");
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.m920of("device");
        private static final FieldDescriptor LOG_DESCRIPTOR = FieldDescriptor.m920of("log");
        private static final FieldDescriptor ROLLOUTS_DESCRIPTOR = FieldDescriptor.m920of("rollouts");
    ...
    private static final class CrashlyticsReportSessionEventApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application> {
        ...
        private static final FieldDescriptor EXECUTION_DESCRIPTOR = FieldDescriptor.m920of("execution");
        private static final FieldDescriptor CUSTOMATTRIBUTES_DESCRIPTOR = FieldDescriptor.m920of("customAttributes");
        private static final FieldDescriptor INTERNALKEYS_DESCRIPTOR = FieldDescriptor.m920of("internalKeys");
        private static final FieldDescriptor BACKGROUND_DESCRIPTOR = FieldDescriptor.m920of("background");
        ...
        private static final FieldDescriptor UIORIENTATION_DESCRIPTOR = FieldDescriptor.m920of("uiOrientation");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution> {
        ...
        private static final FieldDescriptor THREADS_DESCRIPTOR = FieldDescriptor.m920of("threads");
        private static final FieldDescriptor EXCEPTION_DESCRIPTOR = FieldDescriptor.m920of("exception");
        private static final FieldDescriptor APPEXITINFO_DESCRIPTOR = FieldDescriptor.m920of("appExitInfo");
        private static final FieldDescriptor SIGNAL_DESCRIPTOR = FieldDescriptor.m920of("signal");
        private static final FieldDescriptor BINARIES_DESCRIPTOR = FieldDescriptor.m920of("binaries");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionThreadEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread> {
        ...
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.m920of(AppMeasurementSdk.ConditionalUserProperty.NAME);
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.m920of("importance");
        private static final FieldDescriptor FRAMES_DESCRIPTOR = FieldDescriptor.m920of("frames");
    ...
    /* loaded from: classes2.dex */
    private static final class C1482xc3999712 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> {
        static final C1482xc3999712 INSTANCE = new C1482xc3999712();
        private static final FieldDescriptor PC_DESCRIPTOR = FieldDescriptor.m920of("pc");
        private static final FieldDescriptor SYMBOL_DESCRIPTOR = FieldDescriptor.m920of("symbol");
        private static final FieldDescriptor FILE_DESCRIPTOR = FieldDescriptor.m920of("file");
        private static final FieldDescriptor OFFSET_DESCRIPTOR = FieldDescriptor.m920of(TypedValues.CycleType.S_WAVE_OFFSET);
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.m920of("importance");

        private C1482xc3999712() {
        }
    ...
    /* loaded from: classes2.dex */
    private static final class C1481x55689506 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Exception> {
        static final C1481x55689506 INSTANCE = new C1481x55689506();
        private static final FieldDescriptor TYPE_DESCRIPTOR = FieldDescriptor.m920of("type");
        private static final FieldDescriptor REASON_DESCRIPTOR = FieldDescriptor.m920of("reason");
        private static final FieldDescriptor FRAMES_DESCRIPTOR = FieldDescriptor.m920of("frames");
        private static final FieldDescriptor CAUSEDBY_DESCRIPTOR = FieldDescriptor.m920of("causedBy");
        private static final FieldDescriptor OVERFLOWCOUNT_DESCRIPTOR = FieldDescriptor.m920of("overflowCount");

        private C1481x55689506() {
        }
    ...
    private static final class CrashlyticsReportApplicationExitInfoEncoder implements ObjectEncoder<CrashlyticsReport.ApplicationExitInfo> {
        ...
        private static final FieldDescriptor REASONCODE_DESCRIPTOR = FieldDescriptor.m920of("reasonCode");
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.m920of("importance");
        private static final FieldDescriptor PSS_DESCRIPTOR = FieldDescriptor.m920of("pss");
        private static final FieldDescriptor RSS_DESCRIPTOR = FieldDescriptor.m920of("rss");
        private static final FieldDescriptor TIMESTAMP_DESCRIPTOR = FieldDescriptor.m920of("timestamp");
        private static final FieldDescriptor TRACEFILE_DESCRIPTOR = FieldDescriptor.m920of("traceFile");
        private static final FieldDescriptor BUILDIDMAPPINGFORARCH_DESCRIPTOR = FieldDescriptor.m920of("buildIdMappingForArch");
    ...
    private static final class CrashlyticsReportApplicationExitInfoBuildIdMappingForArchEncoder implements ObjectEncoder<CrashlyticsReport.ApplicationExitInfo.BuildIdMappingForArch> {
        ...
        private static final FieldDescriptor ARCH_DESCRIPTOR = FieldDescriptor.m920of("arch");
        private static final FieldDescriptor LIBRARYNAME_DESCRIPTOR = FieldDescriptor.m920of("libraryName");
        private static final FieldDescriptor BUILDID_DESCRIPTOR = FieldDescriptor.m920of("buildId");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionSignalEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Signal> {
        ...
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.m920of(AppMeasurementSdk.ConditionalUserProperty.NAME);
        private static final FieldDescriptor CODE_DESCRIPTOR = FieldDescriptor.m920of("code");
        private static final FieldDescriptor ADDRESS_DESCRIPTOR = FieldDescriptor.m920of("address");
    ...
    /* loaded from: classes2.dex */
    private static final class C1480x99c932db implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        static final C1480x99c932db INSTANCE = new C1480x99c932db();
        private static final FieldDescriptor BASEADDRESS_DESCRIPTOR = FieldDescriptor.m920of("baseAddress");
        private static final FieldDescriptor SIZE_DESCRIPTOR = FieldDescriptor.m920of("size");
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.m920of(AppMeasurementSdk.ConditionalUserProperty.NAME);
        private static final FieldDescriptor UUID_DESCRIPTOR = FieldDescriptor.m920of("uuid");

        private C1480x99c932db() {
        }
    ...
    private static final class CrashlyticsReportCustomAttributeEncoder implements ObjectEncoder<CrashlyticsReport.CustomAttribute> {
        ...
        private static final FieldDescriptor KEY_DESCRIPTOR = FieldDescriptor.m920of("key");
        private static final FieldDescriptor VALUE_DESCRIPTOR = FieldDescriptor.m920of("value");
    ...
    private static final class CrashlyticsReportSessionEventDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Device> {
        ...
        private static final FieldDescriptor BATTERYLEVEL_DESCRIPTOR = FieldDescriptor.m920of("batteryLevel");
        private static final FieldDescriptor BATTERYVELOCITY_DESCRIPTOR = FieldDescriptor.m920of("batteryVelocity");
        private static final FieldDescriptor PROXIMITYON_DESCRIPTOR = FieldDescriptor.m920of("proximityOn");
        private static final FieldDescriptor ORIENTATION_DESCRIPTOR = FieldDescriptor.m920of("orientation");
        private static final FieldDescriptor RAMUSED_DESCRIPTOR = FieldDescriptor.m920of("ramUsed");
        private static final FieldDescriptor DISKUSED_DESCRIPTOR = FieldDescriptor.m920of("diskUsed");
    ...
    private static final class CrashlyticsReportSessionEventLogEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Log> {
        ...
        private static final FieldDescriptor CONTENT_DESCRIPTOR = FieldDescriptor.m920of(FirebaseAnalytics.Param.CONTENT);
    ...
    private static final class CrashlyticsReportSessionEventRolloutsStateEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.RolloutsState> {
        ...
        private static final FieldDescriptor ASSIGNMENTS_DESCRIPTOR = FieldDescriptor.m920of("assignments");
    ...
    private static final class CrashlyticsReportSessionEventRolloutAssignmentEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.RolloutAssignment> {
        ...
        private static final FieldDescriptor ROLLOUTVARIANT_DESCRIPTOR = FieldDescriptor.m920of("rolloutVariant");
        private static final FieldDescriptor PARAMETERKEY_DESCRIPTOR = FieldDescriptor.m920of("parameterKey");
        private static final FieldDescriptor PARAMETERVALUE_DESCRIPTOR = FieldDescriptor.m920of("parameterValue");
        private static final FieldDescriptor TEMPLATEVERSION_DESCRIPTOR = FieldDescriptor.m920of(RemoteConfigConstants.ResponseFieldKey.TEMPLATE_VERSION_NUMBER);
    ...
    /* loaded from: classes2.dex */
    private static final class C1483x319e1f5b implements ObjectEncoder<CrashlyticsReport.Session.Event.RolloutAssignment.RolloutVariant> {
        static final C1483x319e1f5b INSTANCE = new C1483x319e1f5b();
        private static final FieldDescriptor ROLLOUTID_DESCRIPTOR = FieldDescriptor.m920of(ConfigContainer.ROLLOUT_METADATA_ID);
        private static final FieldDescriptor VARIANTID_DESCRIPTOR = FieldDescriptor.m920of("variantId");

        private C1483x319e1f5b() {
        }
    ...
    private static final class CrashlyticsReportFilesPayloadEncoder implements ObjectEncoder<CrashlyticsReport.FilesPayload> {
        ...
        private static final FieldDescriptor FILES_DESCRIPTOR = FieldDescriptor.m920of("files");
        private static final FieldDescriptor ORGID_DESCRIPTOR = FieldDescriptor.m920of("orgId");
    ...
    private static final class CrashlyticsReportFilesPayloadFileEncoder implements ObjectEncoder<CrashlyticsReport.FilesPayload.File> {
        ...
        private static final FieldDescriptor FILENAME_DESCRIPTOR = FieldDescriptor.m920of("filename");
        private static final FieldDescriptor CONTENTS_DESCRIPTOR = FieldDescriptor.m920of("contents");
