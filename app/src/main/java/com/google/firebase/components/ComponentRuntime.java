...
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
    ...
    private ComponentRuntime(Executor executor, Iterable<Provider<ComponentRegistrar>> iterable, Collection<Component<?>> collection, ComponentRegistrarProcessor componentRegistrarProcessor) {
        ...
        arrayList.add(Component.m874of(eventBus, (Class<EventBus>) EventBus.class, (Class<? super EventBus>[]) new Class[]{Subscriber.class, Publisher.class}));
        arrayList.add(Component.m874of(this, (Class<ComponentRuntime>) ComponentLoader.class, (Class<? super ComponentRuntime>[]) new Class[0]));
        ...
        synchronized (this) {
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: com.google.firebase.components.ComponentRuntime$$ExternalSyntheticLambda2
                    @Override // com.google.firebase.inject.Provider
                    public final Object get() {
                        return ComponentRuntime.this.m875xc080f8d8(component);
                    }
                }));
            }
    ...
    public /* synthetic */ Object m875xc080f8d8(Component component) {
    ...
    public <T> Deferred<T> getDeferred(Qualified<T> qualified) {
        ...
        return OptionalProvider.m876of(provider);
    }
    ...
    public void initializeEagerComponents(boolean z) {
        HashMap hashMap;
        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m284m(this.eagerComponentsInitializedWith, null, Boolean.valueOf(z))) {
            synchronized (this) {
