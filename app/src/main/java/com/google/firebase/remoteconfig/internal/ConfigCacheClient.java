...
public class ConfigCacheClient {
    ...
    public /* synthetic */ Void m931xddaae01c(ConfigContainer configContainer) throws Exception {
    ...
    public Task<ConfigContainer> put(final ConfigContainer configContainer, final boolean z) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.internal.ConfigCacheClient$$ExternalSyntheticLambda0
            ...
            public final Object call() {
                return ConfigCacheClient.this.m931xddaae01c(configContainer);
            }
            ...
            public final Task then(Object obj) {
                return ConfigCacheClient.this.m932x9820809d(z, configContainer, (Void) obj);
            }
        });
    }
    ...
    public /* synthetic */ Task m932x9820809d(boolean z, ConfigContainer configContainer, Void r3) throws Exception {
        if (z) {
