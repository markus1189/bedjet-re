...
public final class zzb {
    private static final ImmutableSet<String> zza = ImmutableSet.m767of("_in", "_xa", "_xu", "_aq", "_aa", "_ai", "_ac", FirebaseAnalytics.Event.CAMPAIGN_DETAILS, "_ug", "_iapx", "_exp_set", "_exp_clear", "_exp_activate", "_exp_timeout", "_exp_expire");
    private static final ImmutableList<String> zzb = ImmutableList.m721of("_e", "_f", "_iap", "_s", "_au", "_ui", "_cd");
    private static final ImmutableList<String> zzc = ImmutableList.m717of(DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "app", "am");
    private static final ImmutableList<String> zzd = ImmutableList.m716of("_r", "_dbg");
    private static final ImmutableList<String> zze = new ImmutableList.Builder().add((Object[]) zzjj.zza).add((Object[]) zzjj.zzb).build();
    private static final ImmutableList<String> zzf = ImmutableList.m716of("^_ltv_[A-Z]{3}$", "^_cc[1-5]{1}$");
