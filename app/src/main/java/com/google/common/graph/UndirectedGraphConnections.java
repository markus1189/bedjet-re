...
final class UndirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    /* renamed from: of */
    public static <N, V> UndirectedGraphConnections<N, V> m830of(ElementOrder<N> elementOrder) {
        int i = C12931.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i == 1) {
