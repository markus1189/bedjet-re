...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
    ...
    /* renamed from: of */
    public static <E> ImmutableSet<E> m761of() {
        return RegularImmutableSet.EMPTY;
    }

    /* renamed from: of */
    public static <E> ImmutableSet<E> m762of(E e) {
        return new SingletonImmutableSet(e);
    }

    /* renamed from: of */
    public static <E> ImmutableSet<E> m763of(E e, E e2) {
        return construct(2, e, e2);
    }

    /* renamed from: of */
    public static <E> ImmutableSet<E> m764of(E e, E e2, E e3) {
        return construct(3, e, e2, e3);
    }

    /* renamed from: of */
    public static <E> ImmutableSet<E> m765of(E e, E e2, E e3, E e4) {
        return construct(4, e, e2, e3, e4);
    }

    /* renamed from: of */
    public static <E> ImmutableSet<E> m766of(E e, E e2, E e3, E e4, E e5) {
        return construct(5, e, e2, e3, e4, e5);
    }

    @SafeVarargs
    /* renamed from: of */
    public static <E> ImmutableSet<E> m767of(E e, E e2, E e3, E e4, E e5, E e6, E... eArr) {
    ...
    public static <E> ImmutableSet<E> construct(int i, Object... objArr) {
        ...
        if (i == 1) {
            return m762of(Objects.requireNonNull(objArr[0]));
        }
    ...
    public static class Builder<E> extends ImmutableCollection.ArrayBasedBuilder<E> {
        ...
        public ImmutableSet<E> build() {
            ...
            if (i == 1) {
                return ImmutableSet.m762of(Objects.requireNonNull(this.contents[0]));
            }
            if (this.hashTable == null || ImmutableSet.chooseTableSize(this.size) != this.hashTable.length) {
