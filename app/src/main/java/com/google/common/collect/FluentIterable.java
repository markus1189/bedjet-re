...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    FluentIterable(Iterable<E> iterable) {
        this.iterableDelegate = Optional.m687of(iterable);
    }

    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo681or((Optional<Iterable<E>>) this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m699of() {
        return from(Collections.emptyList());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m700of(@ParametricNullness E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m687of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m687of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m687of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m687of(next);
    }
