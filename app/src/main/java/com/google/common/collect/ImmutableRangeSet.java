...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m714of());
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m715of(Range.all()));
    ...
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m759of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m760of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m715of(range));
    }
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        if (this.ranges.size() == 1 && this.ranges.get(0).equals(Range.all())) {
            ImmutableRangeSet<C> m759of = m759of();
            this.complement = m759of;
            return m759of;
        }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> discreteDomain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m809of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (build.isEmpty()) {
                return ImmutableRangeSet.m759of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m715of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
