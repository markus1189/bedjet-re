...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m683is(char c) {
        return new C0997Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m683is(charSequence.charAt(0));
        }
        if (length == 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo684or(CharMatcher charMatcher) {
        return new C0998Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m683is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    /* loaded from: classes2.dex */
    public static final class C0998Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C0998Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    /* loaded from: classes2.dex */
    public static final class C0997Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo684or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo684or(charMatcher);
        }
