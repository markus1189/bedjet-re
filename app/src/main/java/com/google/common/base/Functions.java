...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f212f;

        /* renamed from: g */
        private final Function<B, C> f213g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f213g = (Function) Preconditions.checkNotNull(function);
            this.f212f = (Function) Preconditions.checkNotNull(function2);
        }

        @Override // com.google.common.base.Function
        @ParametricNullness
        public C apply(@ParametricNullness A a) {
            return (C) this.f213g.apply(this.f212f.apply(a));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            return this.f212f.equals(functionComposition.f212f) && this.f213g.equals(functionComposition.f213g);
        }

        public int hashCode() {
            return this.f212f.hashCode() ^ this.f213g.hashCode();
        }

        public String toString() {
            String valueOf = String.valueOf(this.f213g);
            String valueOf2 = String.valueOf(this.f212f);
