...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m690or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m691or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy(predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m689or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m688in(Collection<? extends T> collection) {
    ...
    public static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f214f;

        /* renamed from: p */
        final Predicate<B> f215p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f215p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f214f = (Function) Preconditions.checkNotNull(function);
        }

        @Override // com.google.common.base.Predicate
        public boolean apply(@ParametricNullness A a) {
            return this.f215p.apply(this.f214f.apply(a));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            return this.f214f.equals(compositionPredicate.f214f) && this.f215p.equals(compositionPredicate.f215p);
        }

        public int hashCode() {
            return this.f214f.hashCode() ^ this.f215p.hashCode();
        }

        public String toString() {
            String valueOf = String.valueOf(this.f215p);
            String valueOf2 = String.valueOf(this.f214f);
