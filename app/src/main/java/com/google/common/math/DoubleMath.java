...
public final class DoubleMath {
    ...
    static double roundIntermediate(double d, RoundingMode roundingMode) {
        ...
        switch (C13321.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C13321 {
    ...
    */
    public static int log2(double r6, java.math.RoundingMode r8) {
        ...
        L11:
            ...
            return r6
        L2b:
            int[] r1 = com.google.common.math.DoubleMath.C13321.$SwitchMap$java$math$RoundingMode
            int r8 = r8.ordinal()
            r8 = r1[r8]
            switch(r8) {
                case 1: goto L63;
