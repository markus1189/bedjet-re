...
public final class TypeResolver {
    ...
    private static class WildcardCapturer {
        ...
        /* renamed from: id */
        private final AtomicInteger f286id;
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            int incrementAndGet = this.f286id.incrementAndGet();
            String join = Joiner.m685on(Typography.amp).join(typeArr);
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this, this.f286id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f286id);
        }
