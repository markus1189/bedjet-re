...
public final class MediaType {
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m728of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m686on("; ").withKeyValueSeparator("=");

    private static MediaType createConstant(String str, String str2) {
        MediaType addKnownType = addKnownType(new MediaType(str, str2, ImmutableListMultimap.m727of()));
    ...
    private static MediaType createConstantUtf8(String str, String str2) {
        ...
        addKnownType.parsedCharset = Optional.m687of(Charsets.UTF_8);
        return addKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                String next = it.next();
                if (str == null) {
                    optional = Optional.m687of(Charset.forName(next));
                    str = next;
    ...
    public MediaType withParameter(String str, String str2) {
        return withParameters(str, ImmutableSet.m762of(str2));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType withParameter = withParameter(CHARSET_ATTRIBUTE, charset.name());
        withParameter.parsedCharset = Optional.m687of(charset);
    ...
    /* renamed from: is */
    public boolean m839is(MediaType mediaType) {
    ...
    public static MediaType create(String str, String str2) {
        MediaType create = create(str, str2, ImmutableListMultimap.m727of());
