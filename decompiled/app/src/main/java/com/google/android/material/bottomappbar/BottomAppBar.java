...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C0675R.style.Widget_MaterialComponents_BottomAppBar;
    private static final int FAB_ALIGNMENT_ANIM_DURATION_ATTR = C0675R.attr.motionDurationLong2;
    private static final int FAB_ALIGNMENT_ANIM_EASING_ATTR = C0675R.attr.motionEasingEmphasizedInterpolator;
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0675R.attr.bottomAppBarStyle);
    }
    ...
    */
    ...
    protected int getActionMenuViewTranslationX(ActionMenuView actionMenuView, int i, boolean z) {
        ...
        if (getNavigationIcon() == null) {
            i2 = getResources().getDimensionPixelOffset(C0675R.dimen.m3_bottomappbar_horizontal_padding);
            if (!isLayoutRtl) {
                i2 = -i2;
            }
        }
            ...
            this.fabLayoutListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.Behavior.1
                ...
                public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    ...
                    if (Behavior.this.originalBottomMargin == 0) {
                        if (bottomAppBar.fabAnchorMode == 1) {
                            layoutParams.bottomMargin = bottomAppBar.getBottomInset() + (bottomAppBar.getResources().getDimensionPixelOffset(C0675R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((view.getMeasuredHeight() - height) / 2));
                        }
            ...
            if (findDependentView != null && !ViewCompat.isLaidOut(findDependentView)) {
                ...
                if (findDependentView instanceof FloatingActionButton) {
                    ...
                    if (floatingActionButton.getShowMotionSpec() == null) {
                        floatingActionButton.setShowMotionSpecResource(C0675R.animator.mtrl_fab_show_motion_spec);
                    }
                    if (floatingActionButton.getHideMotionSpec() == null) {
                        floatingActionButton.setHideMotionSpecResource(C0675R.animator.mtrl_fab_hide_motion_spec);
                    }
