    ...
    final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (DeviceProperties.isWearable(context)) {
            ...
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                style.addAction(C0667R.drawable.common_full_open_on_phone, resources.getString(C0667R.string.common_open_on_phone), pendingIntent);
            } else {
                style.setContentIntent(pendingIntent);
            }
        } else {
            style.setSmallIcon(android.R.drawable.stat_sys_warning).setTicker(resources.getString(C0667R.string.common_google_play_services_notification_ticker)).setWhen(System.currentTimeMillis()).setContentIntent(pendingIntent).setContentText(zad);
        }
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                String string = context.getResources().getString(C0667R.string.common_google_play_services_notification_channel_name);
                if (notificationChannel == null) {
                    notificationManager.createNotificationChannel(Transition$Impl26$$ExternalSyntheticApiModelOutline0.m436m("com.google.android.gms.availability", string, 4));
                } else {
