...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C0675R.attr.snackbarStyle};
    ...
    public BaseTransientBottomBar(Context context, ViewGroup viewGroup, View view, com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        this.animationSlideDuration = MotionUtils.resolveThemeDuration(context, C0675R.attr.motionDurationLong2, 250);
        this.animationFadeInDuration = MotionUtils.resolveThemeDuration(context, C0675R.attr.motionDurationLong2, DEFAULT_ANIMATION_FADE_IN_DURATION);
        this.animationFadeOutDuration = MotionUtils.resolveThemeDuration(context, C0675R.attr.motionDurationMedium1, 75);
        this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(context, C0675R.attr.motionEasingEmphasizedInterpolator, DEFAULT_ANIMATION_FADE_INTERPOLATOR);
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(context, C0675R.attr.motionEasingEmphasizedInterpolator, DEFAULT_ANIMATION_SCALE_INTERPOLATOR);
        this.animationSlideInterpolator = MotionUtils.resolveThemeInterpolator(context, C0675R.attr.motionEasingEmphasizedInterpolator, DEFAULT_ANIMATION_SLIDE_INTERPOLATOR);
    }
    ...
    protected int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C0675R.layout.mtrl_layout_snackbar : C0675R.layout.design_layout_snackbar;
    }
    ...
    */
    void onAttachedToWindow() {
        /*
            ...
            android.view.WindowInsets r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m989m(r0)
            if (r0 == 0) goto L1b
            android.graphics.Insets r0 = androidx.print.PrintHelper$$ExternalSyntheticApiModelOutline0.m293m(r0)
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C0675R.styleable.SnackbarLayout);
            if (obtainStyledAttributes.hasValue(C0675R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, obtainStyledAttributes.getDimensionPixelSize(C0675R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = obtainStyledAttributes.getInt(C0675R.styleable.SnackbarLayout_animationMode, 0);
            if (obtainStyledAttributes.hasValue(C0675R.styleable.SnackbarLayout_shapeAppearance) || obtainStyledAttributes.hasValue(C0675R.styleable.SnackbarLayout_shapeAppearanceOverlay)) {
                this.shapeAppearanceModel = ShapeAppearanceModel.builder(context2, attributeSet, 0, 0).build();
            }
            this.backgroundOverlayColorAlpha = obtainStyledAttributes.getFloat(C0675R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, obtainStyledAttributes, C0675R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C0675R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = obtainStyledAttributes.getFloat(C0675R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            this.maxWidth = obtainStyledAttributes.getDimensionPixelSize(C0675R.styleable.SnackbarLayout_android_maxWidth, -1);
            this.maxInlineActionWidth = obtainStyledAttributes.getDimensionPixelSize(C0675R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
            obtainStyledAttributes.recycle();
        ...
        private Drawable createThemedBackground() {
            int layer = MaterialColors.layer(this, C0675R.attr.colorSurface, C0675R.attr.colorOnSurface, getBackgroundOverlayColorAlpha());
    ...
    public static GradientDrawable createGradientDrawableBackground(int i, Resources resources) {
        float dimension = resources.getDimension(C0675R.dimen.mtrl_snackbar_background_corner_radius);
