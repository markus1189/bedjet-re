    ...
    public static Map<Integer, Integer> quantize(int[] iArr, int[] iArr2, int i) {
        ...
        while (true) {
            ...
            for (int i31 = 0; i31 < min; i31++) {
                int i32 = iArr11[i31];
                if (i32 == 0) {
                    dArr2[i31] = new double[]{FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE};
                } else {
                    double d3 = i32;
