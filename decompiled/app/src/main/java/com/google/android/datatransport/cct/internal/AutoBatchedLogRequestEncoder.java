...
public final class AutoBatchedLogRequestEncoder implements Configurator {
    ...
    private static final class BatchedLogRequestEncoder implements ObjectEncoder<BatchedLogRequest> {
        ...
        private static final FieldDescriptor LOGREQUEST_DESCRIPTOR = FieldDescriptor.m920of("logRequest");
    ...
    private static final class LogRequestEncoder implements ObjectEncoder<LogRequest> {
        ...
        private static final FieldDescriptor REQUESTTIMEMS_DESCRIPTOR = FieldDescriptor.m920of("requestTimeMs");
        private static final FieldDescriptor REQUESTUPTIMEMS_DESCRIPTOR = FieldDescriptor.m920of("requestUptimeMs");
        private static final FieldDescriptor CLIENTINFO_DESCRIPTOR = FieldDescriptor.m920of("clientInfo");
        private static final FieldDescriptor LOGSOURCE_DESCRIPTOR = FieldDescriptor.m920of("logSource");
        private static final FieldDescriptor LOGSOURCENAME_DESCRIPTOR = FieldDescriptor.m920of("logSourceName");
        private static final FieldDescriptor LOGEVENT_DESCRIPTOR = FieldDescriptor.m920of("logEvent");
        private static final FieldDescriptor QOSTIER_DESCRIPTOR = FieldDescriptor.m920of("qosTier");
    ...
    private static final class ClientInfoEncoder implements ObjectEncoder<ClientInfo> {
        ...
        private static final FieldDescriptor CLIENTTYPE_DESCRIPTOR = FieldDescriptor.m920of("clientType");
        private static final FieldDescriptor ANDROIDCLIENTINFO_DESCRIPTOR = FieldDescriptor.m920of("androidClientInfo");
    ...
    private static final class AndroidClientInfoEncoder implements ObjectEncoder<AndroidClientInfo> {
        ...
        private static final FieldDescriptor HARDWARE_DESCRIPTOR = FieldDescriptor.m920of("hardware");
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.m920of("device");
        private static final FieldDescriptor PRODUCT_DESCRIPTOR = FieldDescriptor.m920of("product");
        private static final FieldDescriptor OSBUILD_DESCRIPTOR = FieldDescriptor.m920of("osBuild");
        private static final FieldDescriptor MANUFACTURER_DESCRIPTOR = FieldDescriptor.m920of("manufacturer");
        private static final FieldDescriptor FINGERPRINT_DESCRIPTOR = FieldDescriptor.m920of("fingerprint");
        private static final FieldDescriptor LOCALE_DESCRIPTOR = FieldDescriptor.m920of("locale");
        private static final FieldDescriptor COUNTRY_DESCRIPTOR = FieldDescriptor.m920of("country");
        private static final FieldDescriptor MCCMNC_DESCRIPTOR = FieldDescriptor.m920of("mccMnc");
        private static final FieldDescriptor APPLICATIONBUILD_DESCRIPTOR = FieldDescriptor.m920of("applicationBuild");
    ...
    private static final class LogEventEncoder implements ObjectEncoder<LogEvent> {
        ...
        private static final FieldDescriptor EVENTTIMEMS_DESCRIPTOR = FieldDescriptor.m920of("eventTimeMs");
        private static final FieldDescriptor EVENTCODE_DESCRIPTOR = FieldDescriptor.m920of("eventCode");
        private static final FieldDescriptor COMPLIANCEDATA_DESCRIPTOR = FieldDescriptor.m920of("complianceData");
        private static final FieldDescriptor EVENTUPTIMEMS_DESCRIPTOR = FieldDescriptor.m920of("eventUptimeMs");
        private static final FieldDescriptor SOURCEEXTENSION_DESCRIPTOR = FieldDescriptor.m920of("sourceExtension");
        private static final FieldDescriptor SOURCEEXTENSIONJSONPROTO3_DESCRIPTOR = FieldDescriptor.m920of("sourceExtensionJsonProto3");
        private static final FieldDescriptor TIMEZONEOFFSETSECONDS_DESCRIPTOR = FieldDescriptor.m920of("timezoneOffsetSeconds");
        private static final FieldDescriptor NETWORKCONNECTIONINFO_DESCRIPTOR = FieldDescriptor.m920of("networkConnectionInfo");
        private static final FieldDescriptor EXPERIMENTIDS_DESCRIPTOR = FieldDescriptor.m920of("experimentIds");
    ...
    private static final class ComplianceDataEncoder implements ObjectEncoder<ComplianceData> {
        ...
        private static final FieldDescriptor PRIVACYCONTEXT_DESCRIPTOR = FieldDescriptor.m920of("privacyContext");
        private static final FieldDescriptor PRODUCTIDORIGIN_DESCRIPTOR = FieldDescriptor.m920of("productIdOrigin");
    ...
    private static final class ExternalPrivacyContextEncoder implements ObjectEncoder<ExternalPrivacyContext> {
        ...
        private static final FieldDescriptor PREQUEST_DESCRIPTOR = FieldDescriptor.m920of("prequest");
    ...
    private static final class ExternalPRequestContextEncoder implements ObjectEncoder<ExternalPRequestContext> {
        ...
        private static final FieldDescriptor ORIGINASSOCIATEDPRODUCTID_DESCRIPTOR = FieldDescriptor.m920of("originAssociatedProductId");
    ...
    private static final class NetworkConnectionInfoEncoder implements ObjectEncoder<NetworkConnectionInfo> {
        ...
        private static final FieldDescriptor NETWORKTYPE_DESCRIPTOR = FieldDescriptor.m920of("networkType");
        private static final FieldDescriptor MOBILESUBTYPE_DESCRIPTOR = FieldDescriptor.m920of("mobileSubtype");
    ...
    private static final class ExperimentIdsEncoder implements ObjectEncoder<ExperimentIds> {
        ...
        private static final FieldDescriptor CLEARBLOB_DESCRIPTOR = FieldDescriptor.m920of("clearBlob");
        private static final FieldDescriptor ENCRYPTEDBLOB_DESCRIPTOR = FieldDescriptor.m920of("encryptedBlob");
