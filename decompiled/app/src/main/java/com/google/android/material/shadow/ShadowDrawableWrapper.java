...
public class ShadowDrawableWrapper extends DrawableWrapperCompat {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = ContextCompat.getColor(context, C0675R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = ContextCompat.getColor(context, C0675R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = ContextCompat.getColor(context, C0675R.color.design_fab_shadow_end_color);
