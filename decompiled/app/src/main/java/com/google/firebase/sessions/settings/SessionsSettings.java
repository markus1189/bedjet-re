...
public final class SessionsSettings {
    ...
    */
    ...
    public final long m1418getSessionRestartTimeoutUwyO8pc() {
        Duration mo1416getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo1416getSessionRestartTimeoutFghU774();
        if (mo1416getSessionRestartTimeoutFghU774 != null) {
            long rawValue = mo1416getSessionRestartTimeoutFghU774.getRawValue();
            if (m1417isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration mo1416getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo1416getSessionRestartTimeoutFghU774();
        if (mo1416getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = mo1416getSessionRestartTimeoutFghU7742.getRawValue();
            if (m1417isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m1417isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m2789isPositiveimpl(sessionRestartTimeout) && Duration.m2784isFiniteimpl(sessionRestartTimeout);
    }
