...
public final /* data */ class DataCollectionStatus {
    ...
    public int hashCode() {
        return (((this.performance.hashCode() * 31) + this.crashlytics.hashCode()) * 31) + UByte$$ExternalSyntheticBackport0.m951m(this.sessionSamplingRate);
    }
