...
public class FirebaseApp {
    ...
    protected FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        ComponentRuntime.Builder processor = ComponentRuntime.builder(UiExecutor.INSTANCE).addLazyComponentRegistrars(discoverLazy).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponentRegistrar(new ExecutorsRegistrar()).addComponent(Component.m874of(context, (Class<Context>) Context.class, (Class<? super Context>[]) new Class[0])).addComponent(Component.m874of(this, (Class<FirebaseApp>) FirebaseApp.class, (Class<? super FirebaseApp>[]) new Class[0])).addComponent(Component.m874of(firebaseOptions, (Class<FirebaseOptions>) FirebaseOptions.class, (Class<? super FirebaseOptions>[]) new Class[0])).setProcessor(new ComponentMonitor());
        if (UserManagerCompat.isUserUnlocked(context) && FirebaseInitProvider.isCurrentlyInitializing()) {
            processor.addComponent(Component.m874of(startupTime, (Class<StartupTime>) StartupTime.class, (Class<? super StartupTime>[]) new Class[0]));
        }
        ...
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return FirebaseApp.this.m1404lambda$new$0$comgooglefirebaseFirebaseApp(context);
            }
        });
        ...
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda1
            ...
            public final void onBackgroundStateChanged(boolean z) {
                FirebaseApp.this.m1405lambda$new$1$comgooglefirebaseFirebaseApp(z);
            }
        });
        FirebaseTrace.popTrace();
    }
    ...
    public /* synthetic */ DataCollectionConfigStorage m1404lambda$new$0$comgooglefirebaseFirebaseApp(Context context) {
    ...
    public /* synthetic */ void m1405lambda$new$1$comgooglefirebaseFirebaseApp(boolean z) {
        if (z) {
            return;
        }
    ...
    public static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context context) {
            if (INSTANCE.get() == null) {
                ...
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m284m(INSTANCE, null, userUnlockReceiver)) {
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m284m(INSTANCE, null, globalBackgroundStateListener)) {
