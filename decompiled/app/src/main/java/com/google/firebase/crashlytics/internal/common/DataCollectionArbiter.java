...
public class DataCollectionArbiter {
    ...
    private void logDataCollectionState(boolean z) {
        ...
        Logger.getLogger().m891d(String.format("Crashlytics automatic data collection %s by %s.", str2, str));
    }
    ...
    private static Boolean readCrashlyticsDataCollectionEnabledFromManifest(Context context) {
        ...
        try {
            ...
            Logger.getLogger().m894e("Could not read data collection permission from manifest", e);
            return null;
        }
    }
