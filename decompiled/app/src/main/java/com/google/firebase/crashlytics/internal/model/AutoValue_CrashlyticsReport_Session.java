...
final class AutoValue_CrashlyticsReport_Session extends CrashlyticsReport.Session {
    ...
    /* renamed from: os */
    private final CrashlyticsReport.Session.OperatingSystem f288os;
    ...
    public String toString() {
        return "Session{generator=" + this.generator + ", identifier=" + this.identifier + ", appQualitySessionId=" + this.appQualitySessionId + ", startedAt=" + this.startedAt + ", endedAt=" + this.endedAt + ", crashed=" + this.crashed + ", app=" + this.app + ", user=" + this.user + ", os=" + this.f288os + ", device=" + this.device + ", events=" + this.events + ", generatorType=" + this.generatorType + "}";
    }
    ...
    public int hashCode() {
        ...
        CrashlyticsReport.Session.OperatingSystem operatingSystem = this.f288os;
    ...
    public static final class Builder extends CrashlyticsReport.Session.Builder {
        ...
        /* renamed from: os */
        private CrashlyticsReport.Session.OperatingSystem f289os;
        private byte set$0;
        ...
        public CrashlyticsReport.Session build() {
            ...
            return new AutoValue_CrashlyticsReport_Session(str, str2, this.appQualitySessionId, this.startedAt, this.endedAt, this.crashed, application, this.user, this.f289os, this.device, this.events, this.generatorType);
        }
    }
}
