...
public final class Component<T> {
    ...
    @Deprecated
    /* renamed from: of */
    public static <T> Component<T> m872of(Class<T> cls, final T t) {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m874of(final T t, Class<T> cls, Class<? super T>... clsArr) {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m873of(final T t, Qualified<T> qualified, Qualified<? super T>... qualifiedArr) {
