...
public class SettingsController implements SettingsProvider {
    ...
    public Task<Void> loadSettingsData(SettingsCacheBehavior settingsCacheBehavior, CrashlyticsWorkers crashlyticsWorkers) {
        ...
        return this.dataCollectionArbiter.waitForDataCollectionPermission().onSuccessTask(crashlyticsWorkers.common, new C15111(crashlyticsWorkers));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.google.firebase.crashlytics.internal.settings.SettingsController$1 */
    /* loaded from: classes2.dex */
    public class C15111 implements SuccessContinuation<Void, Void> {
        final /* synthetic */ CrashlyticsWorkers val$crashlyticsWorkers;

        C15111(CrashlyticsWorkers crashlyticsWorkers) {
        ...
        public Task<Void> then(Void r5) throws Exception {
            JSONObject jSONObject = (JSONObject) this.val$crashlyticsWorkers.network.getExecutor().submit(new Callable() { // from class: com.google.firebase.crashlytics.internal.settings.SettingsController$1$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return SettingsController.C15111.this.m919xd7ba6dd6();
                }
            }).get();
            if (jSONObject != null) {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: lambda$then$0$com-google-firebase-crashlytics-internal-settings-SettingsController$1 */
        public /* synthetic */ JSONObject m919xd7ba6dd6() throws Exception {
                ...
                if (readCachedSettings != null) {
                    ...
                    if (parseSettingsJson != null) {
                        ...
                        if (!SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior) && parseSettingsJson.isExpired(currentTimeMillis)) {
                            Logger.getLogger().m897v("Cached settings have expired.");
                        }
                        try {
                            Logger.getLogger().m897v("Returning cached settings.");
                            settings = parseSettingsJson;
                        } catch (Exception e) {
                            e = e;
                            settings = parseSettingsJson;
                            Logger.getLogger().m894e("Failed to get cached settings", e);
                            return settings;
                        }
                    } else {
                        Logger.getLogger().m894e("Failed to parse cached settings data.", null);
                    }
                } else {
                    Logger.getLogger().m891d("No cached settings data found.");
                }
            }
        } catch (Exception e2) {
            e = e2;
    ...
    public void logSettings(JSONObject jSONObject, String str) {
        Logger.getLogger().m891d(str + jSONObject.toString());
    }
