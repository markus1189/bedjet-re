...
final class C1502x94fa915f extends CrashlyticsReport.Session.Event.Application.ProcessDetails {
    private final boolean defaultProcess;
    private final int importance;
    private final int pid;
    private final String processName;

    private C1502x94fa915f(String str, int i, int i2, boolean z) {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.ProcessDetails.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.ProcessDetails build() {
            ...
            return new C1502x94fa915f(str, this.pid, this.importance, this.defaultProcess);
        }
    }
}
