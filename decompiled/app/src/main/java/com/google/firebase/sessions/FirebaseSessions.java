...
public final class FirebaseSessions {
    ...
    public FirebaseSessions(FirebaseApp firebaseApp, SessionsSettings settings, CoroutineContext backgroundDispatcher, SessionLifecycleServiceBinder lifecycleServiceBinder) {
        ...
        if (applicationContext instanceof Application) {
            ...
            BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(backgroundDispatcher), null, null, new C15501(backgroundDispatcher, lifecycleServiceBinder, null), 3, null);
        } else {
    ...
    @DebugMetadata(m962c = "com.google.firebase.sessions.FirebaseSessions$1", m963f = "FirebaseSessions.kt", m964i = {}, m965l = {45, ConstraintLayout.LayoutParams.Table.LAYOUT_EDITOR_ABSOLUTEX}, m966m = "invokeSuspend", m967n = {}, m968s = {})
    /* renamed from: com.google.firebase.sessions.FirebaseSessions$1 */
    /* loaded from: classes2.dex */
    static final class C15501 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C15501(CoroutineContext coroutineContext, SessionLifecycleServiceBinder sessionLifecycleServiceBinder, Continuation<? super C15501> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C15501(this.$backgroundDispatcher, this.$lifecycleServiceBinder, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C15501) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r6) {
            ...
            La6:
                ...
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.sessions.FirebaseSessions.C15501.invokeSuspend(java.lang.Object):java.lang.Object");
        }
