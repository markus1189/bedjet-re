...
public final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    public static /* synthetic */ class C15161 {
        ...
        static final /* synthetic */ int[] f292x531607dd;
        ...
        static {
            ...
            try {
                f292x531607dd[Protobuf.IntEncoding.SIGNED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f292x531607dd[Protobuf.IntEncoding.FIXED.ordinal()] = 3;
    ...
    public ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        ...
        int i2 = C15161.f292x531607dd[protobuf.intEncoding().ordinal()];
        if (i2 == 1) {
    ...
    public ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        ...
        Protobuf protobuf = getProtobuf(fieldDescriptor);
        int i = C15161.f292x531607dd[protobuf.intEncoding().ordinal()];
        if (i == 1) {
            writeVarInt32(protobuf.tag() << 3);
            writeVarInt64(j);
        } else if (i == 2) {
    ...
    public ObjectEncoderContext nested(String str) throws IOException {
        return nested(FieldDescriptor.m920of(str));
    }
