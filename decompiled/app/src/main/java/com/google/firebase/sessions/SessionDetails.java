...
public final /* data */ class SessionDetails {
    ...
    public int hashCode() {
        return (((((this.sessionId.hashCode() * 31) + this.firstSessionId.hashCode()) * 31) + this.sessionIndex) * 31) + UByte$$ExternalSyntheticBackport0.m953m(this.sessionStartTimestampUs);
    }
