...
public class FirebaseCrashlytics {
    ...
    public static FirebaseCrashlytics init(FirebaseApp firebaseApp, FirebaseInstallationsApi firebaseInstallationsApi, Deferred<CrashlyticsNativeComponent> deferred, Deferred<AnalyticsConnector> deferred2, Deferred<FirebaseRemoteConfigInterop> deferred3, ExecutorService executorService, ExecutorService executorService2, ExecutorService executorService3) {
        ...
        Logger.getLogger().m895i("Initializing Firebase Crashlytics " + CrashlyticsCore.getVersion() + " for " + packageName);
        ...
        Logger.getLogger().m891d("Mapping file ID is: " + mappingFileId);
        for (BuildIdInfo buildIdInfo2 : buildIdInfo) {
            Logger.getLogger().m891d(String.format("Build id for %s on %s: %s", buildIdInfo2.getLibraryName(), buildIdInfo2.getArch(), buildIdInfo2.getBuildId()));
        }
        try {
            ...
            Logger.getLogger().m897v("Installer package name is: " + create.installerPackageName);
            ...
            create2.loadSettingsData(crashlyticsWorkers).addOnFailureListener(executorService3, new OnFailureListener() { // from class: com.google.firebase.crashlytics.FirebaseCrashlytics$$ExternalSyntheticLambda0
                ...
                public final void onFailure(Exception exc) {
                    Logger.getLogger().m894e("Error fetching settings.", exc);
                }
            });
            ...
            Logger.getLogger().m894e("Error retrieving app package info.", e);
            return null;
        }
    }
    ...
    public void recordException(Throwable th) {
        if (th == null) {
            Logger.getLogger().m899w("A null value was passed to recordException. Ignoring.");
        } else {
