...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda2
            ...
            public final void run() {
                FirebaseInstallations.this.m924xc18eb11d();
            }
        });
    ...
    public /* synthetic */ void m924xc18eb11d() {
        m925x7147f7aa(false);
    }
    ...
    public Task<InstallationTokenResult> getToken(final boolean z) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseInstallations.this.m925x7147f7aa(z);
            }
        });
    ...
    public final void m925x7147f7aa(final boolean z) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseInstallations.this.m923x5a306a82(z);
            }
        });
    }
    ...
    */
    public void m923x5a306a82(boolean r3) {
        /*
            r2 = this;
        ...
        L5f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.FirebaseInstallations.m923x5a306a82(boolean):void");
    }
    ...
    private PersistedInstallationEntry registerFidWithServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C15223.f293xc38d2559[createFirebaseInstallation.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C15223.f294xe5baa01a[generateAuthToken.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    public static /* synthetic */ class C15223 {
        ...
        static {
            ...
            try {
                f294xe5baa01a[TokenResult.ResponseCode.BAD_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f294xe5baa01a[TokenResult.ResponseCode.AUTH_ERROR.ordinal()] = 3;
            ...
            try {
                f293xc38d2559[InstallationResponse.ResponseCode.BAD_CONFIG.ordinal()] = 2;
