...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public V get(@CheckForNull Object obj, @CheckForNull Object obj2) {
        ...
        return m698at(num.intValue(), num2.intValue());
    }
    ...
    public Table.Cell<R, C, V> getCell(int i) {
        return new Tables.AbstractCell<R, C, V>(i) { // from class: com.google.common.collect.ArrayTable.2
            ...
            @CheckForNull
            public V getValue() {
                return (V) ArrayTable.this.m698at(this.rowIndex, this.columnIndex);
            }
        };
    }
    ...
    public V getValue(int i) {
        return m698at(i / this.columnList.size(), i % this.columnList.size());
    }
    ...
    public class Column extends ArrayMap<R, V> {
        ...
        @CheckForNull
        V getValue(int i) {
            return (V) ArrayTable.this.m698at(i, this.columnIndex);
        }
    ...
    public class Row extends ArrayMap<C, V> {
        ...
        @CheckForNull
        V getValue(int i) {
            return (V) ArrayTable.this.m698at(this.rowIndex, i);
        }
