...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    /* loaded from: classes2.dex */
    public class C12641 extends AbstractGraph<N> {
        C12641() {
        }
        ...
        public /* bridge */ /* synthetic */ Iterable predecessors(Object obj) {
            return predecessors((C12641) obj);
        }
        ...
        public Set<EndpointPair<N>> edges() {
            ...
            return new AbstractSet<EndpointPair<N>>() { // from class: com.google.common.graph.AbstractNetwork.1.1
                ...
                public boolean contains(@CheckForNull Object obj) {
                    ...
                    return C12641.this.isOrderingCompatible(endpointPair) && C12641.this.nodes().contains(endpointPair.nodeU()) && C12641.this.successors((C12641) endpointPair.nodeU()).contains(endpointPair.nodeV());
                }
            };
        }
    ...
    public Set<E> adjacentEdges(E e) {
        ...
        return Sets.difference(Sets.union(incidentEdges(incidentNodes.nodeU()), incidentEdges(incidentNodes.nodeV())), ImmutableSet.m762of((Object) e));
    }
