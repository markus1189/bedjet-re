...
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V> implements ListMultimap<K, V> {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m727of() {
        return EmptyImmutableListMultimap.INSTANCE;
    }

    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m728of(K k, V v) {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m729of(K k, V v, K k2, V v2) {
        Builder builder = builder();
        builder.put((Builder) k, (K) v);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m730of(K k, V v, K k2, V v2, K k3, V v3) {
        Builder builder = builder();
        builder.put((Builder) k, (K) v);
        builder.put((Builder) k2, (K) v2);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m731of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        Builder builder = builder();
        builder.put((Builder) k, (K) v);
        builder.put((Builder) k2, (K) v2);
        builder.put((Builder) k3, (K) v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m732of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        Builder builder = builder();
        builder.put((Builder) k, (K) v);
        builder.put((Builder) k2, (K) v2);
        builder.put((Builder) k3, (K) v3);
    ...
    public ImmutableList<V> get(K k) {
        ...
        return immutableList == null ? ImmutableList.m714of() : immutableList;
    }
