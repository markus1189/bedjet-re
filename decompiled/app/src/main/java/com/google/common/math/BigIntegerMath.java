...
public final class BigIntegerMath {
    ...
    public static int log2(BigInteger bigInteger, RoundingMode roundingMode) {
        ...
        int i = bitLength - 1;
        switch (C13311.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C13311 {
    ...
    */
    public static int log10(java.math.BigInteger r7, java.math.RoundingMode r8) {
        ...
        L60:
            r2 = r4
        L61:
            int[] r3 = com.google.common.math.BigIntegerMath.C13311.$SwitchMap$java$math$RoundingMode
            int r8 = r8.ordinal()
            r8 = r3[r8]
            switch(r8) {
                case 1: goto L95;
