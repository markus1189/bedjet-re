...
public abstract class AbstractService implements Service {
    ...
    public final Service stopAsync() {
        if (this.monitor.enterIf(this.isStoppable)) {
            try {
                ...
                switch (C13896.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()]) {
                    case 1:
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C13896 {
    ...
    public final void notifyFailed(Throwable th) {
        ...
        try {
            Service.State state = state();
            int i = C13896.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()];
            if (i != 1) {
                if (i == 2 || i == 3 || i == 4) {
