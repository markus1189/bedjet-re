...
public final class SimpleTimeLimiter implements TimeLimiter {
    ...
    public <T> T newProxy(T t, Class<T> cls, long j, TimeUnit timeUnit) {
        ...
        return (T) newProxy(cls, new C14411(t, j, timeUnit, findInterruptibleMethods(cls)));
    }

    /* renamed from: com.google.common.util.concurrent.SimpleTimeLimiter$1 */
    /* loaded from: classes2.dex */
    class C14411 implements InvocationHandler {
        ...
        C14411(Object obj, long j, TimeUnit timeUnit, Set set) {
            this.val$target = obj;
        ...
        public Object invoke(Object obj, final Method method, @CheckForNull final Object[] objArr) throws Throwable {
            ...
            return SimpleTimeLimiter.this.callWithTimeout(new Callable() { // from class: com.google.common.util.concurrent.SimpleTimeLimiter$1$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return SimpleTimeLimiter.C14411.lambda$invoke$0(method, obj2, objArr);
                }
