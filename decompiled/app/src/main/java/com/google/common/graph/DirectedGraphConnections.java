...
public final class DirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: of */
    public static <N, V> DirectedGraphConnections<N, V> m824of(ElementOrder<N> elementOrder) {
        ArrayList arrayList;
        int i = C12735.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i == 1) {
            arrayList = null;
        } else if (i == 2) {
