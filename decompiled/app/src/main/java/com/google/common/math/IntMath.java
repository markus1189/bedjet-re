...
public final class IntMath {
    ...
    private static final int[] factorials = {1, 1, 2, 6, 24, 120, BiorhythmFragment.MAX_DURATION_IN_MINUTES, 5040, 40320, 362880, 3628800, 39916800, 479001600};
    ...
    public static int log2(int i, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", i);
        switch (C13331.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
