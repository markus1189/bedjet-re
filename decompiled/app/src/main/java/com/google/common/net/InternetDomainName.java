...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.m692on('.');
    private static final Joiner DOT_JOINER = Joiner.m685on('.');
    ...
    static {
        ...
        CharMatcher mo684or = CharMatcher.inRange('a', 'z').mo684or(CharMatcher.inRange('A', 'Z'));
        LETTER_MATCHER = mo684or;
        PART_CHAR_MATCHER = inRange.mo684or(mo684or).mo684or(anyOf);
    }
    ...
    InternetDomainName(String str) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m687of(PublicSuffixType.REGISTRY));
    }
