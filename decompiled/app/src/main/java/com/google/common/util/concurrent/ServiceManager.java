...
public final class ServiceManager implements ServiceManagerBridge {
    ...
    public ServiceManager(Iterable<? extends Service> iterable) {
        ...
        if (copyOf.isEmpty()) {
            ...
            copyOf = ImmutableList.m715of(new NoOpService());
        }
    ...
    public static final class ServiceManagerState {
        ...
        void awaitHealthy(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.awaitHealthGuard, j, timeUnit)) {
                    String valueOf = String.valueOf(Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.m688in(ImmutableSet.m763of(Service.State.NEW, Service.State.STARTING))));
        ...
        void awaitStopped(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                ...
                String valueOf = String.valueOf(Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.not(Predicates.m688in(EnumSet.of(Service.State.TERMINATED, Service.State.FAILED)))));
