...
public class Subscriber {
    ...
    public final void dispatchEvent(final Object obj) {
        this.executor.execute(new Runnable() { // from class: com.google.common.eventbus.Subscriber$$ExternalSyntheticLambda0
            ...
            public final void run() {
                Subscriber.this.m1397lambda$dispatchEvent$0$comgooglecommoneventbusSubscriber(obj);
            }
        });
    }
    ...
    public /* synthetic */ void m1397lambda$dispatchEvent$0$comgooglecommoneventbusSubscriber(Object obj) {
        try {
