...
public final class ImmutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    private static final ImmutableClassToInstanceMap<Object> EMPTY = new ImmutableClassToInstanceMap<>(ImmutableMap.m733of());
    private final ImmutableMap<Class<? extends B>, B> delegate;

    /* renamed from: of */
    public static <B> ImmutableClassToInstanceMap<B> m712of() {
        return (ImmutableClassToInstanceMap<B>) EMPTY;
    }

    /* renamed from: of */
    public static <B, T extends B> ImmutableClassToInstanceMap<B> m713of(Class<T> cls, T t) {
        return new ImmutableClassToInstanceMap<>(ImmutableMap.m734of(cls, t));
    }
    ...
    public static final class Builder<B> {
        ...
        public ImmutableClassToInstanceMap<B> build() {
            ...
            if (buildOrThrow.isEmpty()) {
                return ImmutableClassToInstanceMap.m712of();
            }
