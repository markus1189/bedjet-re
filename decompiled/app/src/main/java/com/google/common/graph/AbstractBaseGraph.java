...
public abstract class AbstractBaseGraph<N> implements BaseGraph<N> {
    ...
    public Set<EndpointPair<N>> edges() {
        return new AbstractSet<EndpointPair<N>>() { // from class: com.google.common.graph.AbstractBaseGraph.1
            ...
            public UnmodifiableIterator<EndpointPair<N>> iterator() {
                return EndpointPairIterator.m829of(AbstractBaseGraph.this);
            }
    ...
    public Set<EndpointPair<N>> incidentEdges(N n) {
        ...
        return new C12622(this, this, n);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.google.common.graph.AbstractBaseGraph$2 */
    /* loaded from: classes2.dex */
    public class C12622 extends IncidentEdgeSet<N> {
        C12622(AbstractBaseGraph abstractBaseGraph, BaseGraph baseGraph, Object obj) {
            super(baseGraph, obj);
        }
        ...
        public UnmodifiableIterator<EndpointPair<N>> iterator() {
            if (this.graph.isDirected()) {
                return Iterators.unmodifiableIterator(Iterators.concat(Iterators.transform(this.graph.predecessors((BaseGraph<N>) this.node).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return AbstractBaseGraph.C12622.this.m1398lambda$iterator$0$comgooglecommongraphAbstractBaseGraph$2(obj);
                    }
                }), Iterators.transform(Sets.difference(this.graph.successors((BaseGraph<N>) this.node), ImmutableSet.m762of(this.node)).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda1
                    @Override // com.google.common.base.Function
                    public final Object apply(Object obj) {
                        return AbstractBaseGraph.C12622.this.m1399lambda$iterator$1$comgooglecommongraphAbstractBaseGraph$2(obj);
                    }
                })));
            }
            return Iterators.unmodifiableIterator(Iterators.transform(this.graph.adjacentNodes(this.node).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda2
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
                    return AbstractBaseGraph.C12622.this.m1400lambda$iterator$2$comgooglecommongraphAbstractBaseGraph$2(obj);
                }
            }));
        }
        ...
        public /* synthetic */ EndpointPair m1398lambda$iterator$0$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
        ...
        public /* synthetic */ EndpointPair m1399lambda$iterator$1$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
        ...
        public /* synthetic */ EndpointPair m1400lambda$iterator$2$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
