...
public class CharJVM {
    public static final CharCategoryJVM getCategory(char c) {
        return CharCategoryJVM.INSTANCE.valueOf(Character.getType(c));
    }
