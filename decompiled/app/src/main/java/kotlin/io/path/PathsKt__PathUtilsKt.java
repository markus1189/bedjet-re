...
public class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final List<Path> listDirectoryEntries(Path path, String glob) throws IOException {
        ...
        try {
            DirectoryStream m1072m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1072m((Object) directoryStream);
            Intrinsics.checkNotNull(m1072m);
            List<Path> list = CollectionsKt.toList(m1072m);
            Closeable.closeFinally(directoryStream, null);
            return list;
        } finally {
        }
    }
    ...
    static /* synthetic */ Object useDirectoryEntries$default(Path path, String glob, Function1 block, int i, Object obj) throws IOException {
        ...
        try {
            DirectoryStream m1072m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1072m((Object) directoryStream);
            Intrinsics.checkNotNull(m1072m);
            Object invoke = block.invoke(CollectionsKt.asSequence(m1072m));
            ...
            try {
                ...
                InlineMarker.finallyStart(1);
                if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                    Closeable.closeFinally(directoryStream, th);
                } else if (directoryStream != null) {
                    try {
                        directoryStream.close();
    ...
    private static final <T> T useDirectoryEntries(Path path, String glob, Function1<? super Sequence<? extends Path>, ? extends T> block) throws IOException {
        ...
        try {
            DirectoryStream m1072m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1072m((Object) directoryStream);
            Intrinsics.checkNotNull(m1072m);
            T invoke = block.invoke(CollectionsKt.asSequence(m1072m));
            InlineMarker.finallyStart(1);
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                Closeable.closeFinally(directoryStream, null);
            } else if (directoryStream != null) {
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... options) {
        ...
        fileAttributeView = Files.getFileAttributeView(path, StreamsKt$$ExternalSyntheticApiModelOutline0.m1064m(), (LinkOption[]) Arrays.copyOf(options, options.length));
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        if (fileAttributeView != null) {
            return (V) StreamsKt$$ExternalSyntheticApiModelOutline0.m1098m((Object) fileAttributeView);
        }
        Intrinsics.reifiedOperationMarker(4, "V");
        PathsKt.fileAttributeViewNotAvailable(path, StreamsKt$$ExternalSyntheticApiModelOutline0.m1064m());
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        readAttributes = Files.readAttributes(path, (Class<BasicFileAttributes>) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m995m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        Intrinsics.checkNotNullExpressionValue(readAttributes, "readAttributes(...)");
        return (A) StreamsKt$$ExternalSyntheticApiModelOutline0.m1097m((Object) readAttributes);
    }
