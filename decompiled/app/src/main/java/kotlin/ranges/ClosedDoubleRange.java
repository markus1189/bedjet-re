...
final class ClosedDoubleRange implements ClosedFloatingPointRange<Double> {
    ...
    public int hashCode() {
        ...
        return (UByte$$ExternalSyntheticBackport0.m951m(this._start) * 31) + UByte$$ExternalSyntheticBackport0.m951m(this._endInclusive);
    }
