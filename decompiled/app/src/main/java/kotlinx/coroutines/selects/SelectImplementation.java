...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
        ...
        while (true) {
            ...
            if (obj instanceof CancellableContinuation) {
                ...
                if (findClause == null) {
                    ...
                    if (C0129xc40028dd.m88m(state$volatile$FU, this, obj, findClause)) {
                        this.internalResult = internalResult;
                ...
                if (Intrinsics.areEqual(obj, SelectKt.access$getSTATE_REG$p())) {
                    if (C0129xc40028dd.m88m(state$volatile$FU, this, obj, CollectionsKt.listOf(clauseObject))) {
                        return 1;
                    }
                } else {
                    ...
                    if (C0129xc40028dd.m88m(state$volatile$FU, this, obj, CollectionsKt.plus((Collection<? extends Object>) obj, clauseObject))) {
                        return 1;
                    }
                }
            }
    ...
    */
    public final java.lang.Object processResultAndInvokeBlockRecoveringException(kotlinx.coroutines.selects.SelectImplementation<R>.ClauseData r5, java.lang.Object r6, kotlin.coroutines.Continuation<? super R> r7) {
        /*
            r4 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.selects.C1643xf491fb2a
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.selects.SelectImplementation$processResultAndInvokeBlockRecoveringException$1 r0 = (kotlinx.coroutines.selects.C1643xf491fb2a) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
        ...
        L50:
            ...
            java.lang.Throwable r5 = kotlinx.coroutines.internal.StackTraceRecovery.access$recoverFromStackFrame(r5, r0)
            throw r5
        L57:
            throw r5
        */
    ...
    public void invoke(Throwable cause) {
        ...
        } while (!C0129xc40028dd.m88m(atomicReferenceFieldUpdater, this, obj, SelectKt.access$getSTATE_CANCELLED$p()));
        List<SelectImplementation<R>.ClauseData> list = this.clauses;
        if (list == null) {
            return;
        }
    ...
    */
    public final java.lang.Object waitUntilSelected(kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L14:
            ...
            boolean r3 = androidx.concurrent.futures.C0129xc40028dd.m88m(r4, r6, r3, r1)
            if (r3 == 0) goto L14
            r2 = r6
        ...
        L2f:
            ...
            boolean r4 = androidx.concurrent.futures.C0129xc40028dd.m88m(r4, r6, r3, r5)
            if (r4 == 0) goto L14
            r4 = r3
