...
@DebugMetadata(m962c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m963f = "Deprecated.kt", m964i = {0, 0, 1, 1, 1}, m965l = {153, 156}, m966m = "lastOrNull", m967n = {"$this$consume$iv", "iterator", "$this$consume$iv", "iterator", "last"}, m968s = {"L$0", "L$1", "L$0", "L$1", "L$2"})
