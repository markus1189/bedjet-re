...
public interface SendChannel<E> {
    ...
    Object mo2934trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo2934trySendJP2dKIU = sendChannel.mo2934trySendJP2dKIU(e);
            if (ChannelResult.m2959isSuccessimpl(mo2934trySendJP2dKIU)) {
                return true;
            }
            Throwable m2953exceptionOrNullimpl = ChannelResult.m2953exceptionOrNullimpl(mo2934trySendJP2dKIU);
