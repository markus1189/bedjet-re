...
@DebugMetadata(m962c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$takeWhile$1", m963f = "Deprecated.kt", m964i = {0, 1, 1, 2}, m965l = {299, MaterialCardViewHelper.DEFAULT_FADE_ANIM_DURATION, 301}, m966m = "invokeSuspend", m967n = {"$this$produce", "$this$produce", "e", "$this$produce"}, m968s = {"L$0", "L$0", "L$2", "L$0"})
