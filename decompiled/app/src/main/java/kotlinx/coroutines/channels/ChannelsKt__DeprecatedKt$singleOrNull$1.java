...
@DebugMetadata(m962c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m963f = "Deprecated.kt", m964i = {0, 0, 1, 1}, m965l = {179, 182}, m966m = "singleOrNull", m967n = {"$this$consume$iv", "iterator", "$this$consume$iv", "single"}, m968s = {"L$0", "L$1", "L$0", "L$1"})
