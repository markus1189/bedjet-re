...
@Metadata(m942d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\n"}, m943d2 = {"<anonymous>", "", "Lkotlinx/coroutines/flow/FlowCollector;", "Lkotlinx/coroutines/flow/SharingCommand;"}, m944k = 3, m945mv = {2, 0, 0}, m947xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
@DebugMetadata(m962c = "kotlinx.coroutines.flow.StartedLazily$command$1", m963f = "SharingStarted.kt", m964i = {}, m965l = {151}, m966m = "invokeSuspend", m967n = {}, m968s = {})
...
final class StartedLazily$command$1 extends SuspendLambda implements Function2<FlowCollector<? super SharingCommand>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$subscriptionCount.collect(new C16361(booleanRef, flowCollector), this) == coroutine_suspended) {
    ...
    /* loaded from: classes2.dex */
    public static final class C16361<T> implements FlowCollector {
        final /* synthetic */ FlowCollector<SharingCommand> $$this$flow;
        final /* synthetic */ Ref.BooleanRef $started;

        /* JADX WARN: Multi-variable type inference failed */
        C16361(Ref.BooleanRef booleanRef, FlowCollector<? super SharingCommand> flowCollector) {
        ...
        */
        public final java.lang.Object emit(int r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
            ...
            L51:
                ...
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.StartedLazily$command$1.C16361.emit(int, kotlin.coroutines.Continuation):java.lang.Object");
        }
