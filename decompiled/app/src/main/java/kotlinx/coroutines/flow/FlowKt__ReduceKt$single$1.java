...
@DebugMetadata(m962c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", m963f = "Reduce.kt", m964i = {0}, m965l = {ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_BASELINE_TO_BOTTOM_OF}, m966m = "single", m967n = {"result"}, m968s = {"L$0"})
