...
@DebugMetadata(m962c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", m963f = "Zip.kt", m964i = {}, m965l = {304}, m966m = "invokeSuspend", m967n = {}, m968s = {})
...
public final class FlowKt__ZipKt$combineTransform$7<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes2.dex */
    public static final class C16331<T> implements Function0<T[]> {
        final /* synthetic */ Flow<T>[] $flowArray;

        public C16331(Flow<T>[] flowArr) {
            this.$flowArray = flowArr;
        }
    ...
    @DebugMetadata(m962c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", m963f = "Zip.kt", m964i = {}, m965l = {304}, m966m = "invokeSuspend", m967n = {}, m968s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 */
    /* loaded from: classes2.dex */
    public static final class C16342<T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        final /* synthetic */ Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> $transform;
        private /* synthetic */ Object L$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C16342(Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C16342> continuation) {
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            ...
            C16342 c16342 = new C16342(this.$transform, continuation);
            c16342.L$0 = flowCollector;
            c16342.L$1 = tArr;
            return c16342.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Intrinsics.needClassReification();
            C16331 c16331 = new C16331(this.$flowArray);
            Intrinsics.needClassReification();
            this.label = 1;
            if (CombineKt.combineInternal(flowCollector, flowArr, c16331, new C16342(this.$transform, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, c16331, new C16342(this.$transform, null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
