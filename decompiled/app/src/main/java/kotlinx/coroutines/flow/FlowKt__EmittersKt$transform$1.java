...
@DebugMetadata(m962c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$transform$1", m963f = "Emitters.kt", m964i = {}, m965l = {36}, m966m = "invokeSuspend", m967n = {}, m968s = {})
...
public final class FlowKt__EmittersKt$transform$1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes2.dex */
    public static final class C15911<T> implements FlowCollector {
        final /* synthetic */ FlowCollector<R> $$this$flow;
        final /* synthetic */ Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> $transform;

        /* JADX WARN: Multi-variable type inference failed */
        public C15911(Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function3, FlowCollector<? super R> flowCollector) {
            this.$transform = function3;
        ...
        */
        public final java.lang.Object emit(T r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
            ...
            L42:
                ...
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__EmittersKt$transform$1.C15911.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
        }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$this_transform.collect(new C15911(this.$transform, flowCollector), this) == coroutine_suspended) {
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        FlowCollector flowCollector = (FlowCollector) this.L$0;
        InlineMarker.mark(0);
        this.$this_transform.collect(new C15911(this.$transform, flowCollector), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
