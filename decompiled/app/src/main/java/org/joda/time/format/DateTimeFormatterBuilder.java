...
public class DateTimeFormatterBuilder {
    ...
    public DateTimePrinter toPrinter() {
        ...
        if (isPrinter(formatter)) {
            return InternalPrinterDateTimePrinter.m1151of((InternalPrinter) formatter);
        }
    ...
    public DateTimeParser toParser() {
        ...
        if (isParser(formatter)) {
            return InternalParserDateTimeParser.m1150of((InternalParser) formatter);
        }
    ...
    public DateTimeFormatterBuilder append(DateTimePrinter dateTimePrinter) {
        ...
        return append0(DateTimePrinterInternalPrinter.m1149of(dateTimePrinter), null);
    }

    public DateTimeFormatterBuilder append(DateTimeParser dateTimeParser) {
        checkParser(dateTimeParser);
        return append0(null, DateTimeParserInternalParser.m1148of(dateTimeParser));
    }

    public DateTimeFormatterBuilder append(DateTimePrinter dateTimePrinter, DateTimeParser dateTimeParser) {
        checkPrinter(dateTimePrinter);
        checkParser(dateTimeParser);
        return append0(DateTimePrinterInternalPrinter.m1149of(dateTimePrinter), DateTimeParserInternalParser.m1148of(dateTimeParser));
    }
    ...
    public DateTimeFormatterBuilder append(DateTimePrinter dateTimePrinter, DateTimeParser[] dateTimeParserArr) {
        ...
        if (length == 1) {
            ...
            return append0(DateTimePrinterInternalPrinter.m1149of(dateTimePrinter), DateTimeParserInternalParser.m1148of(dateTimeParserArr[0]));
        }
        InternalParser[] internalParserArr = new InternalParser[length];
        while (i < length - 1) {
            InternalParser m1148of = DateTimeParserInternalParser.m1148of(dateTimeParserArr[i]);
            internalParserArr[i] = m1148of;
            if (m1148of == null) {
                throw new IllegalArgumentException("Incomplete parser array");
            }
            i++;
        }
        internalParserArr[i] = DateTimeParserInternalParser.m1148of(dateTimeParserArr[i]);
        return append0(DateTimePrinterInternalPrinter.m1149of(dateTimePrinter), new MatchingParser(internalParserArr));
    }

    public DateTimeFormatterBuilder appendOptional(DateTimeParser dateTimeParser) {
        checkParser(dateTimeParser);
        return append0(null, new MatchingParser(new InternalParser[]{DateTimeParserInternalParser.m1148of(dateTimeParser), null}));
    }
