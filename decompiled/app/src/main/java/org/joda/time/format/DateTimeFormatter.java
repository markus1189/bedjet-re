...
public class DateTimeFormatter {
    ...
    public DateTimeFormatter(DateTimePrinter dateTimePrinter, DateTimeParser dateTimeParser) {
        this(DateTimePrinterInternalPrinter.m1149of(dateTimePrinter), DateTimeParserInternalParser.m1148of(dateTimeParser));
    }
    ...
    public DateTimePrinter getPrinter() {
        return InternalPrinterDateTimePrinter.m1151of(this.iPrinter);
    }
    ...
    public DateTimeParser getParser() {
        return InternalParserDateTimeParser.m1150of(this.iParser);
    }
