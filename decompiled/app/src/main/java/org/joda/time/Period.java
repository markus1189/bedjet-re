...
public final class Period extends BasePeriod implements ReadablePeriod, Serializable {
    ...
    public Seconds toStandardSeconds() {
        ...
        return Seconds.seconds(FieldUtils.safeToInt(FieldUtils.safeAdd(FieldUtils.safeAdd(FieldUtils.safeAdd(FieldUtils.safeAdd(FieldUtils.safeAdd(getMillis() / 1000, getSeconds()), getMinutes() * 60), getHours() * EnvironmentConstants.FIREBASE_REMOTE_CONFIG_MINIMUM_FETCH_INTERVAL), getDays() * 86400), getWeeks() * 604800)));
    }
