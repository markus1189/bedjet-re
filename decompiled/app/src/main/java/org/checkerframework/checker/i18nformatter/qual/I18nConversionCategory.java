...
public enum I18nConversionCategory {
    ...
    public String toString() {
        ...
        if (this.types == null) {
            ...
            StringJoiner m1114m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1114m((CharSequence) ", ", (CharSequence) " conversion category (one of: ", (CharSequence) ")");
            for (Class<?> cls : this.types) {
                m1114m.add(cls.getCanonicalName());
            }
            sb.append(m1114m);
        }
        return sb.toString();
