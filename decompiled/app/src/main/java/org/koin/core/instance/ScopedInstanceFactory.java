...
public final class ScopedInstanceFactory<T> extends InstanceFactory<T> {
    ...
    public T get(final InstanceContext context) {
        ...
        KoinPlatformTools.INSTANCE.m3041synchronized(this, new Function0<Unit>(this) { // from class: org.koin.core.instance.ScopedInstanceFactory$get$1
