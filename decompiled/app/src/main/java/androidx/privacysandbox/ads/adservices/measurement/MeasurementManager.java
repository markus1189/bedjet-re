...
public abstract class MeasurementManager {
        ...
        */
        public Api33Ext5Impl(android.content.Context r2) {
            /*
                ...
                java.lang.Class r0 = androidx.privacysandbox.ads.adservices.measurement.DeletionRequest$$ExternalSyntheticApiModelOutline0.m$4()
                java.lang.Object r2 = androidx.core.os.Profiling$$ExternalSyntheticApiModelOutline0.m162m(r2, r0)
                java.lang.String r0 = "context.getSystemService…:class.java\n            )"
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r0)
                android.adservices.measurement.MeasurementManager r2 = androidx.privacysandbox.ads.adservices.measurement.DeletionRequest$$ExternalSyntheticApiModelOutline0.m385m(r2)
                r1.<init>(r2)
                return
            */
        ...
        public final android.adservices.measurement.DeletionRequest convertDeletionRequest(DeletionRequest request) {
            ...
            deletionMode = DeletionRequest$$ExternalSyntheticApiModelOutline0.m380m().setDeletionMode(request.getDeletionMode());
        ...
        public final android.adservices.measurement.WebSourceRegistrationRequest convertWebSourceRequest(WebSourceRegistrationRequest request) {
            ...
            DeletionRequest$$ExternalSyntheticApiModelOutline0.m1283m$1();
            webDestination = DeletionRequest$$ExternalSyntheticApiModelOutline0.m391m((List) convertWebSourceParams(request.getWebSourceParams()), request.getTopOriginUri()).setWebDestination(request.getWebDestination());
        ...
        private final List<android.adservices.measurement.WebSourceParams> convertWebSourceParams(List<WebSourceParams> request) {
            ...
            for (WebSourceParams webSourceParams : request) {
                DeletionRequest$$ExternalSyntheticApiModelOutline0.m1286m$4();
                debugKeyAllowed = DeletionRequest$$ExternalSyntheticApiModelOutline0.m387m(webSourceParams.getRegistrationUri()).setDebugKeyAllowed(webSourceParams.getDebugKeyAllowed());
        ...
        public final android.adservices.measurement.WebTriggerRegistrationRequest convertWebTriggerRequest(WebTriggerRegistrationRequest request) {
            ...
            DeletionRequest$$ExternalSyntheticApiModelOutline0.m1284m$2();
            build = DeletionRequest$$ExternalSyntheticApiModelOutline0.m396m((List) convertWebTriggerParams(request.getWebTriggerParams()), request.getDestination()).build();
            Intrinsics.checkNotNullExpressionValue(build, "Builder(\n               …\n                .build()");
            return build;
        }
        ...
        private final List<android.adservices.measurement.WebTriggerParams> convertWebTriggerParams(List<WebTriggerParams> request) {
            ...
            for (WebTriggerParams webTriggerParams : request) {
                DeletionRequest$$ExternalSyntheticApiModelOutline0.m1285m$3();
                debugKeyAllowed = DeletionRequest$$ExternalSyntheticApiModelOutline0.m394m(webTriggerParams.getRegistrationUri()).setDebugKeyAllowed(webTriggerParams.getDebugKeyAllowed());
                build = debugKeyAllowed.build();
                Intrinsics.checkNotNullExpressionValue(build, "Builder(param.registrati…                 .build()");
                arrayList.add(build);
            }
    ...
    /* compiled from: MeasurementManager.kt */
    @Metadata(m942d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0006\u001a\u0004\u0018\u00010\u00072\u0006\u0010\b\u001a\u00020\tH\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\n"}, m943d2 = {"Landroidx/privacysandbox/ads/adservices/measurement/MeasurementManager$Companion;", "", "()V", "MEASUREMENT_API_STATE_DISABLED", "", "MEASUREMENT_API_STATE_ENABLED", "obtain", "Landroidx/privacysandbox/ads/adservices/measurement/MeasurementManager;", "context", "Landroid/content/Context;", "ads-adservices_release"}, m944k = 1, m945mv = {1, 8, 0}, m947xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
