...
@DebugMetadata(m962c = "androidx.privacysandbox.ads.adservices.java.customaudience.CustomAudienceManagerFutures$Api33Ext4JavaImpl$leaveCustomAudienceAsync$1", m963f = "CustomAudienceManagerFutures.kt", m964i = {}, m965l = {123}, m966m = "invokeSuspend", m967n = {}, m968s = {})
...
final class C0492x236ea9be extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public C0492x236ea9be(CustomAudienceManagerFutures.Api33Ext4JavaImpl api33Ext4JavaImpl, LeaveCustomAudienceRequest leaveCustomAudienceRequest, Continuation<? super C0492x236ea9be> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C0492x236ea9be(this.this$0, this.$request, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((C0492x236ea9be) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
