            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            i3 += UByte$$ExternalSyntheticBackport0.m953m(jArr[i6]) ^ UByte$$ExternalSyntheticBackport0.m953m(jArr2[i6]);
                        }
                        j >>= 8;
                    }
                    if (i4 != 8) {
