...
public class SimpleArrayMap<K, V> {
    ...
    private final int indexOf(K key, int hash) {
        ...
        int binarySearch = ContainerHelpers.binarySearch(this.hashes, i, hash);
    ...
    private final int indexOfNull() {
        ...
        int binarySearch = ContainerHelpers.binarySearch(this.hashes, i, 0);
