...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(m942d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m943d2 = {"<anonymous>", "", "T", "it"}, m944k = 3, m945mv = {1, 5, 1}, m947xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @DebugMetadata(m962c = "androidx.datastore.migrations.SharedPreferencesMigration$1", m963f = "SharedPreferencesMigration.kt", m964i = {}, m965l = {}, m966m = "invokeSuspend", m967n = {}, m968s = {})
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$1 */
    /* loaded from: classes.dex */
    static final class C02961 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02961(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Boolean> continuation) {
            return invoke2((C02961) obj, continuation);
        }

        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(T t, Continuation<? super Boolean> continuation) {
            return ((C02961) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, C02961 c02961, Function3 function3, Context context, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) set, (i & 4) != 0 ? new C02961(null) : c02961, function3, context, str);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(m942d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m943d2 = {"<anonymous>", "", "T", "it"}, m944k = 3, m945mv = {1, 5, 1}, m947xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @DebugMetadata(m962c = "androidx.datastore.migrations.SharedPreferencesMigration$2", m963f = "SharedPreferencesMigration.kt", m964i = {}, m965l = {}, m966m = "invokeSuspend", m967n = {}, m968s = {})
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$2 */
    /* loaded from: classes.dex */
    public static final class C02972 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        C02972(Continuation<? super C02972> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02972(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Boolean> continuation) {
            return invoke2((C02972) obj, continuation);
        }

        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(T t, Continuation<? super Boolean> continuation) {
            return ((C02972) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, C02972 c02972, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) ((i & 2) != 0 ? SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS() : set), (i & 4) != 0 ? new C02972(null) : c02972, function3);
    }
    ...
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(m942d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m943d2 = {"<anonymous>", "", "T", "it"}, m944k = 3, m945mv = {1, 5, 1}, m947xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @DebugMetadata(m962c = "androidx.datastore.migrations.SharedPreferencesMigration$3", m963f = "SharedPreferencesMigration.kt", m964i = {}, m965l = {}, m966m = "invokeSuspend", m967n = {}, m968s = {})
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$3 */
    /* loaded from: classes.dex */
    public static final class C02983 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        C02983(Continuation<? super C02983> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02983(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Boolean> continuation) {
            return invoke2((C02983) obj, continuation);
        }

        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(T t, Continuation<? super Boolean> continuation) {
            return ((C02983) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public /* synthetic */ SharedPreferencesMigration(Context context, String str, Set set, C02983 c02983, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, str, (i & 4) != 0 ? SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS() : set, (i & 8) != 0 ? new C02983(null) : c02983, function3);
    }
    ...
    */
    ...
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(m942d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007¨\u0006\t"}, m943d2 = {"Landroidx/datastore/migrations/SharedPreferencesMigration$Api24Impl;", "", "()V", "deleteSharedPreferences", "", "context", "Landroid/content/Context;", AppMeasurementSdk.ConditionalUserProperty.NAME, "", "datastore_release"}, m944k = 1, m945mv = {1, 5, 1}, m947xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
