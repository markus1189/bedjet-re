...
public class ChangeBounds extends Transition {
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        if (!this.mResizeClip || (rect = (Rect) transitionValues.view.getTag(C0571R.id.transition_clip)) == null) {
            return;
        }
    ...
    private static class ClipListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public void onTransitionPause(Transition transition) {
            this.mView.setTag(C0571R.id.transition_clip, this.mView.getClipBounds());
            this.mView.setClipBounds(this.mEndClipIsNull ? null : this.mEndClip);
        }

        @Override // androidx.transition.Transition.TransitionListener
        public void onTransitionResume(Transition transition) {
            Rect rect = (Rect) this.mView.getTag(C0571R.id.transition_clip);
