...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo1288clone = transition.mo1288clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo1288clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo1288clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo1288clone);
    }
    ...
    /* renamed from: go */
    public static void m513go(Scene scene) {
    ...
    public static TransitionSeekController createSeekController(Scene scene, Transition transition) {
        ...
        transitionSet.addTransition(mo1288clone);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
    ...
    /* renamed from: go */
    public static void m514go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo1288clone = transition.mo1288clone();
        sceneChangeSetup(viewGroup, mo1288clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo1288clone);
    }
