...
public class Fade extends Visibility {
    ...
    /* renamed from: IN */
    public static final int f119IN = 1;
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        Float f = (Float) transitionValues.view.getTag(C0571R.id.transition_pause_alpha);
        if (f == null) {
    ...
    public static class FadeAnimatorListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public void onTransitionPause(Transition transition) {
            this.mView.setTag(C0571R.id.transition_pause_alpha, Float.valueOf(this.mView.getVisibility() == 0 ? ViewUtils.getTransitionAlpha(this.mView) : 0.0f));
        }
