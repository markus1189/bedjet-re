...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public int asInt() {
            ...
            int i = this.type;
            if (i == 1) {
                return FlexBuffers.readInt(this.f105bb, this.end, this.parentWidth);
            }
            if (i == 2) {
                readUInt = FlexBuffers.readUInt(this.f105bb, this.end, this.parentWidth);
            } else {
                if (i == 3) {
                    return (int) FlexBuffers.readDouble(this.f105bb, this.end, this.parentWidth);
                }
                if (i == 5) {
                    return Integer.parseInt(asString());
                }
                if (i == 6) {
                    ReadBuf readBuf = this.f105bb;
                    return FlexBuffers.readInt(readBuf, FlexBuffers.indirect(readBuf, this.end, this.parentWidth), this.byteWidth);
                }
                if (i != 7) {
                    if (i == 8) {
                        ReadBuf readBuf2 = this.f105bb;
        ...
        public long asUInt() {
            int i = this.type;
            if (i == 2) {
                return FlexBuffers.readUInt(this.f105bb, this.end, this.parentWidth);
            }
            if (i == 1) {
                return FlexBuffers.readLong(this.f105bb, this.end, this.parentWidth);
            }
            if (i == 3) {
                return (long) FlexBuffers.readDouble(this.f105bb, this.end, this.parentWidth);
            }
            if (i == 10) {
                return asVector().size();
            }
        ...
        public double asFloat() {
            int i = this.type;
            if (i == 3) {
                return FlexBuffers.readDouble(this.f105bb, this.end, this.parentWidth);
            }
            if (i != 1) {
                if (i != 2) {
                    if (i == 5) {
        ...
        public String asString() {
            if (isString()) {
                int indirect = FlexBuffers.indirect(this.f105bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f105bb;
                int i = this.byteWidth;
                return this.f105bb.getString(indirect, (int) FlexBuffers.readUInt(readBuf, indirect - i, i));
            }
            if (isKey()) {
                int indirect2 = FlexBuffers.indirect(this.f105bb, this.end, this.byteWidth);
                int i2 = indirect2;
                while (this.f105bb.get(i2) != 0) {
                    i2++;
                }
                return this.f105bb.getString(indirect2, i2 - indirect2);
            }
            return "";
        }
        ...
        public boolean asBoolean() {
            return isBoolean() ? this.f105bb.get(this.end) != 0 : asUInt() != 0;
        }
    ...
    public static abstract class Sized extends Object {
        ...
        Sized(ReadBuf readBuf, int i, int i2) {
            super(readBuf, i, i2);
            this.size = FlexBuffers.readInt(this.f104bb, i - i2, i2);
        }
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer wrap = ByteBuffer.wrap(this.f104bb.data());
        ...
        public byte[] getBytes() {
            ...
            for (int i = 0; i < size; i++) {
                bArr[i] = this.f104bb.get(this.end + i);
            }
            return bArr;
        }

        public byte get(int i) {
            return this.f104bb.get(this.end + i);
        }

        @Override // androidx.emoji2.text.flatbuffer.FlexBuffers.Object
        public String toString() {
            return this.f104bb.getString(this.end, size());
        }

        @Override // androidx.emoji2.text.flatbuffer.FlexBuffers.Object
        public StringBuilder toString(StringBuilder sb) {
            sb.append(Typography.quote);
            sb.append(this.f104bb.getString(this.end, size()));
            sb.append(Typography.quote);
            return sb;
        }
    }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            int i = this.end;
            while (this.f104bb.get(i) != 0) {
                i++;
            }
            return this.f104bb.getString(this.end, i - this.end);
        }
    ...
    public static class Map extends Vector {
        ...
        public KeyVector keys() {
            ...
            return new KeyVector(new TypedVector(this.f104bb, FlexBuffers.indirect(this.f104bb, i, this.byteWidth), FlexBuffers.readInt(this.f104bb, i + this.byteWidth, this.byteWidth), 4));
        }

        public Vector values() {
            return new Vector(this.f104bb, this.end, this.byteWidth);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f104bb, this.end + (i * this.byteWidth), this.byteWidth, Unsigned.byteToUnsignedInt(this.f104bb.get((int) (this.end + (size * this.byteWidth) + j))));
        }
    }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f104bb, this.end + (i * this.byteWidth), this.byteWidth, 1, this.elemType);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int i) {
            ...
            return new Key(this.vec.f104bb, FlexBuffers.indirect(this.vec.f104bb, this.vec.end + (i * this.vec.byteWidth), this.vec.byteWidth), 1);
        }
