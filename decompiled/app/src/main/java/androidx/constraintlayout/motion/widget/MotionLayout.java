    ...
    */
    ...
    public void updateStateAnimate(int i, ConstraintSet constraintSet, int i2) {
        if (this.mScene != null && this.mCurrentState == i) {
            updateState(C0166R.id.view_transition, getConstraintSet(i));
            setState(C0166R.id.view_transition, -1, -1);
            updateState(i, constraintSet);
            MotionScene.Transition transition = new MotionScene.Transition(-1, this.mScene, C0166R.id.view_transition, i);
