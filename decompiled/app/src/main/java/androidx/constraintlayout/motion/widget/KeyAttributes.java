    ...
    */
    ...
    private static class Loader {
        ...
        static {
            ...
            sAttrMap.append(C0166R.styleable.KeyAttribute_android_elevation, 2);
            sAttrMap.append(C0166R.styleable.KeyAttribute_android_rotation, 4);
            sAttrMap.append(C0166R.styleable.KeyAttribute_android_rotationX, 5);
            sAttrMap.append(C0166R.styleable.KeyAttribute_android_rotationY, 6);
            sAttrMap.append(C0166R.styleable.KeyAttribute_android_transformPivotX, 19);
            sAttrMap.append(C0166R.styleable.KeyAttribute_android_transformPivotY, 20);
            sAttrMap.append(C0166R.styleable.KeyAttribute_android_scaleX, 7);
            sAttrMap.append(C0166R.styleable.KeyAttribute_transitionPathRotate, 8);
            sAttrMap.append(C0166R.styleable.KeyAttribute_transitionEasing, 9);
            sAttrMap.append(C0166R.styleable.KeyAttribute_motionTarget, 10);
            sAttrMap.append(C0166R.styleable.KeyAttribute_framePosition, 12);
            sAttrMap.append(C0166R.styleable.KeyAttribute_curveFit, 13);
            sAttrMap.append(C0166R.styleable.KeyAttribute_android_scaleY, 14);
            sAttrMap.append(C0166R.styleable.KeyAttribute_android_translationX, 15);
            sAttrMap.append(C0166R.styleable.KeyAttribute_android_translationY, 16);
            sAttrMap.append(C0166R.styleable.KeyAttribute_android_translationZ, 17);
            sAttrMap.append(C0166R.styleable.KeyAttribute_motionProgress, 18);
        }
