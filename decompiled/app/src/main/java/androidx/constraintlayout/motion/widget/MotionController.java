...
public class MotionController {
    ...
    public boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            c = 1;
            float f6 = this.mStartMotionPath.f48mX + ((this.mEndMotionPath.f48mX - this.mStartMotionPath.f48mX) * f5);
            float f7 = f6 + 0.5f;
            int i3 = (int) f7;
            float f8 = this.mStartMotionPath.f49mY + ((this.mEndMotionPath.f49mY - this.mStartMotionPath.f49mY) * f5) + 0.5f;
            int i4 = (int) f8;
            int i5 = (int) (f7 + this.mStartMotionPath.mWidth + ((this.mEndMotionPath.mWidth - this.mStartMotionPath.mWidth) * f5));
            int i6 = (int) (f8 + this.mStartMotionPath.mHeight + ((this.mEndMotionPath.mHeight - this.mStartMotionPath.mHeight) * f5));
            int i7 = i5 - i3;
            int i8 = i6 - i4;
