    ...
    */
    ...
    private static class Loader {
        ...
        static {
            ...
            sAttrMap.append(C0166R.styleable.KeyTrigger_onCross, 4);
            sAttrMap.append(C0166R.styleable.KeyTrigger_onNegativeCross, 1);
            sAttrMap.append(C0166R.styleable.KeyTrigger_onPositiveCross, 2);
            sAttrMap.append(C0166R.styleable.KeyTrigger_motionTarget, 7);
            sAttrMap.append(C0166R.styleable.KeyTrigger_triggerId, 6);
            sAttrMap.append(C0166R.styleable.KeyTrigger_triggerSlack, 5);
            sAttrMap.append(C0166R.styleable.KeyTrigger_motion_triggerOnCollision, 9);
            sAttrMap.append(C0166R.styleable.KeyTrigger_motion_postLayoutCollision, 10);
            sAttrMap.append(C0166R.styleable.KeyTrigger_triggerReceiver, 11);
            sAttrMap.append(C0166R.styleable.KeyTrigger_viewTransitionOnCross, 12);
            sAttrMap.append(C0166R.styleable.KeyTrigger_viewTransitionOnNegativeCross, 13);
            sAttrMap.append(C0166R.styleable.KeyTrigger_viewTransitionOnPositiveCross, 14);
        }
