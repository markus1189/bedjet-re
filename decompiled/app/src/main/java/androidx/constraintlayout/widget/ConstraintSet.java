...
public class ConstraintSet {
    ...
    static {
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintLeft_toLeftOf, 25);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintLeft_toRightOf, 26);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintRight_toLeftOf, 29);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintRight_toRightOf, 30);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintTop_toTopOf, 36);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintTop_toBottomOf, 35);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintBottom_toTopOf, 4);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintBottom_toBottomOf, 3);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintBaseline_toBaselineOf, 1);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintBaseline_toTopOf, BASELINE_TO_TOP);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintBaseline_toBottomOf, BASELINE_TO_BOTTOM);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_editor_absoluteX, 6);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_editor_absoluteY, 7);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintGuide_begin, 17);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintGuide_end, 18);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintGuide_percent, 19);
        sMapToConstant.append(C0166R.styleable.Constraint_guidelineUseRtl, GUIDELINE_USE_RTL);
        sMapToConstant.append(C0166R.styleable.Constraint_android_orientation, 27);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintStart_toEndOf, 32);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintStart_toStartOf, 33);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintEnd_toStartOf, 10);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintEnd_toEndOf, 9);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_goneMarginLeft, 13);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_goneMarginTop, 16);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_goneMarginRight, 14);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_goneMarginBottom, 11);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_goneMarginStart, 15);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_goneMarginEnd, 12);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintVertical_weight, 40);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintHorizontal_weight, 39);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintHorizontal_chainStyle, 41);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintVertical_chainStyle, 42);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintHorizontal_bias, 20);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintVertical_bias, 37);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintDimensionRatio, 5);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintLeft_creator, UNUSED);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintTop_creator, UNUSED);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintRight_creator, UNUSED);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintBottom_creator, UNUSED);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintBaseline_creator, UNUSED);
        sMapToConstant.append(C0166R.styleable.Constraint_android_layout_marginLeft, 24);
        sMapToConstant.append(C0166R.styleable.Constraint_android_layout_marginRight, 28);
        sMapToConstant.append(C0166R.styleable.Constraint_android_layout_marginStart, 31);
        sMapToConstant.append(C0166R.styleable.Constraint_android_layout_marginEnd, 8);
        sMapToConstant.append(C0166R.styleable.Constraint_android_layout_marginTop, 34);
        sMapToConstant.append(C0166R.styleable.Constraint_android_layout_marginBottom, 2);
        sMapToConstant.append(C0166R.styleable.Constraint_android_layout_width, 23);
        sMapToConstant.append(C0166R.styleable.Constraint_android_layout_height, 21);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintWidth, LAYOUT_CONSTRAINT_WIDTH);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintHeight, 96);
        sMapToConstant.append(C0166R.styleable.Constraint_android_visibility, 22);
        sMapToConstant.append(C0166R.styleable.Constraint_android_alpha, 43);
        sMapToConstant.append(C0166R.styleable.Constraint_android_elevation, 44);
        sMapToConstant.append(C0166R.styleable.Constraint_android_rotationX, 45);
        sMapToConstant.append(C0166R.styleable.Constraint_android_rotationY, 46);
        sMapToConstant.append(C0166R.styleable.Constraint_android_rotation, 60);
        sMapToConstant.append(C0166R.styleable.Constraint_android_scaleX, 47);
        sMapToConstant.append(C0166R.styleable.Constraint_android_scaleY, 48);
        sMapToConstant.append(C0166R.styleable.Constraint_android_transformPivotX, 49);
        sMapToConstant.append(C0166R.styleable.Constraint_android_transformPivotY, 50);
        sMapToConstant.append(C0166R.styleable.Constraint_android_translationX, 51);
        sMapToConstant.append(C0166R.styleable.Constraint_android_translationY, 52);
        sMapToConstant.append(C0166R.styleable.Constraint_android_translationZ, 53);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintWidth_default, 54);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintHeight_default, 55);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintWidth_max, WIDTH_MAX);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintHeight_max, HEIGHT_MAX);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintWidth_min, WIDTH_MIN);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintHeight_min, HEIGHT_MIN);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintCircle, 61);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintCircleRadius, CIRCLE_RADIUS);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintCircleAngle, 63);
        sMapToConstant.append(C0166R.styleable.Constraint_animateRelativeTo, 64);
        sMapToConstant.append(C0166R.styleable.Constraint_transitionEasing, 65);
        sMapToConstant.append(C0166R.styleable.Constraint_drawPath, 66);
        sMapToConstant.append(C0166R.styleable.Constraint_transitionPathRotate, 67);
        sMapToConstant.append(C0166R.styleable.Constraint_motionStagger, 79);
        sMapToConstant.append(C0166R.styleable.Constraint_android_id, 38);
        sMapToConstant.append(C0166R.styleable.Constraint_motionProgress, 68);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintWidth_percent, 69);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintHeight_percent, 70);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_wrapBehaviorInParent, LAYOUT_WRAP_BEHAVIOR);
        sMapToConstant.append(C0166R.styleable.Constraint_chainUseRtl, 71);
        sMapToConstant.append(C0166R.styleable.Constraint_barrierDirection, 72);
        sMapToConstant.append(C0166R.styleable.Constraint_barrierMargin, 73);
        sMapToConstant.append(C0166R.styleable.Constraint_constraint_referenced_ids, 74);
        sMapToConstant.append(C0166R.styleable.Constraint_barrierAllowsGoneWidgets, 75);
        sMapToConstant.append(C0166R.styleable.Constraint_pathMotionArc, 76);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constraintTag, 77);
        sMapToConstant.append(C0166R.styleable.Constraint_visibilityMode, 78);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constrainedWidth, 80);
        sMapToConstant.append(C0166R.styleable.Constraint_layout_constrainedHeight, 81);
        sMapToConstant.append(C0166R.styleable.Constraint_polarRelativeTo, 82);
        sMapToConstant.append(C0166R.styleable.Constraint_transformPivotTarget, 83);
        sMapToConstant.append(C0166R.styleable.Constraint_quantizeMotionSteps, QUANTIZE_MOTION_STEPS);
        sMapToConstant.append(C0166R.styleable.Constraint_quantizeMotionPhase, QUANTIZE_MOTION_PHASE);
        sMapToConstant.append(C0166R.styleable.Constraint_quantizeMotionInterpolator, QUANTIZE_MOTION_INTERPOLATOR);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_editor_absoluteY, 6);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_editor_absoluteY, 7);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_orientation, 27);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_goneMarginLeft, 13);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_goneMarginTop, 16);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_goneMarginRight, 14);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_goneMarginBottom, 11);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_goneMarginStart, 15);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_goneMarginEnd, 12);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintVertical_weight, 40);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintHorizontal_weight, 39);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintHorizontal_chainStyle, 41);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintVertical_chainStyle, 42);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintHorizontal_bias, 20);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintVertical_bias, 37);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintDimensionRatio, 5);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintLeft_creator, UNUSED);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintTop_creator, UNUSED);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintRight_creator, UNUSED);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintBottom_creator, UNUSED);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintBaseline_creator, UNUSED);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_layout_marginLeft, 24);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_layout_marginRight, 28);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_layout_marginStart, 31);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_layout_marginEnd, 8);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_layout_marginTop, 34);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_layout_marginBottom, 2);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_layout_width, 23);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_layout_height, 21);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintWidth, LAYOUT_CONSTRAINT_WIDTH);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintHeight, 96);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_visibility, 22);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_alpha, 43);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_elevation, 44);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_rotationX, 45);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_rotationY, 46);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_rotation, 60);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_scaleX, 47);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_scaleY, 48);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_transformPivotX, 49);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_transformPivotY, 50);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_translationX, 51);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_translationY, 52);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_translationZ, 53);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintWidth_default, 54);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintHeight_default, 55);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintWidth_max, WIDTH_MAX);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintHeight_max, HEIGHT_MAX);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintWidth_min, WIDTH_MIN);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintHeight_min, HEIGHT_MIN);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintCircleRadius, CIRCLE_RADIUS);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintCircleAngle, 63);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_animateRelativeTo, 64);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_transitionEasing, 65);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_drawPath, 66);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_transitionPathRotate, 67);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_motionStagger, 79);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_android_id, 38);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_motionTarget, MOTION_TARGET);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_motionProgress, 68);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintWidth_percent, 69);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintHeight_percent, 70);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_chainUseRtl, 71);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_barrierDirection, 72);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_barrierMargin, 73);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_constraint_referenced_ids, 74);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_barrierAllowsGoneWidgets, 75);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_pathMotionArc, 76);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constraintTag, 77);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_visibilityMode, 78);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constrainedWidth, 80);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_constrainedHeight, 81);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_polarRelativeTo, 82);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_transformPivotTarget, 83);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_quantizeMotionSteps, QUANTIZE_MOTION_STEPS);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_quantizeMotionPhase, QUANTIZE_MOTION_PHASE);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_quantizeMotionInterpolator, QUANTIZE_MOTION_INTERPOLATOR);
        sOverrideMapToConstant.append(C0166R.styleable.ConstraintOverride_layout_wrapBehaviorInParent, LAYOUT_WRAP_BEHAVIOR);
    }
    ...
    */
    ...
    public static class Layout {
        ...
        static {
            ...
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintLeft_toRightOf, 25);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintRight_toLeftOf, 28);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintRight_toRightOf, 29);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintTop_toTopOf, 35);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintTop_toBottomOf, 34);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintBottom_toTopOf, 4);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintBottom_toBottomOf, 3);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintBaseline_toBaselineOf, 1);
            sMapToConstant.append(C0166R.styleable.Layout_layout_editor_absoluteX, 6);
            sMapToConstant.append(C0166R.styleable.Layout_layout_editor_absoluteY, 7);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintGuide_begin, 17);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintGuide_end, 18);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintGuide_percent, 19);
            sMapToConstant.append(C0166R.styleable.Layout_guidelineUseRtl, GUIDE_USE_RTL);
            sMapToConstant.append(C0166R.styleable.Layout_android_orientation, 26);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintStart_toEndOf, 31);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintStart_toStartOf, 32);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintEnd_toStartOf, 10);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintEnd_toEndOf, 9);
            sMapToConstant.append(C0166R.styleable.Layout_layout_goneMarginLeft, 13);
            sMapToConstant.append(C0166R.styleable.Layout_layout_goneMarginTop, 16);
            sMapToConstant.append(C0166R.styleable.Layout_layout_goneMarginRight, 14);
            sMapToConstant.append(C0166R.styleable.Layout_layout_goneMarginBottom, 11);
            sMapToConstant.append(C0166R.styleable.Layout_layout_goneMarginStart, 15);
            sMapToConstant.append(C0166R.styleable.Layout_layout_goneMarginEnd, 12);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintVertical_weight, 38);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintHorizontal_weight, 37);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintHorizontal_chainStyle, 39);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintVertical_chainStyle, 40);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintHorizontal_bias, 20);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintVertical_bias, 36);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintDimensionRatio, 5);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintLeft_creator, UNUSED);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintTop_creator, UNUSED);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintRight_creator, UNUSED);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintBottom_creator, UNUSED);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintBaseline_creator, UNUSED);
            sMapToConstant.append(C0166R.styleable.Layout_android_layout_marginLeft, 23);
            sMapToConstant.append(C0166R.styleable.Layout_android_layout_marginRight, 27);
            sMapToConstant.append(C0166R.styleable.Layout_android_layout_marginStart, 30);
            sMapToConstant.append(C0166R.styleable.Layout_android_layout_marginEnd, 8);
            sMapToConstant.append(C0166R.styleable.Layout_android_layout_marginTop, 33);
            sMapToConstant.append(C0166R.styleable.Layout_android_layout_marginBottom, 2);
            sMapToConstant.append(C0166R.styleable.Layout_android_layout_width, 22);
            sMapToConstant.append(C0166R.styleable.Layout_android_layout_height, 21);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintWidth, 41);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintHeight, 42);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constrainedWidth, CONSTRAINED_WIDTH);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constrainedHeight, CONSTRAINED_HEIGHT);
            sMapToConstant.append(C0166R.styleable.Layout_layout_wrapBehaviorInParent, 76);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintCircle, 61);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintCircleRadius, CIRCLE_RADIUS);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintCircleAngle, 63);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintWidth_percent, 69);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintHeight_percent, 70);
            sMapToConstant.append(C0166R.styleable.Layout_chainUseRtl, 71);
            sMapToConstant.append(C0166R.styleable.Layout_barrierDirection, 72);
            sMapToConstant.append(C0166R.styleable.Layout_barrierMargin, 73);
            sMapToConstant.append(C0166R.styleable.Layout_constraint_referenced_ids, 74);
            sMapToConstant.append(C0166R.styleable.Layout_barrierAllowsGoneWidgets, 75);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintWidth_max, WIDTH_MAX);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintWidth_min, WIDTH_MIN);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintWidth_max, 83);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintHeight_min, HEIGHT_MIN);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintWidth, CONSTRAINED_WIDTH);
            sMapToConstant.append(C0166R.styleable.Layout_layout_constraintHeight, CONSTRAINED_HEIGHT);
            sMapToConstant.append(C0166R.styleable.ConstraintLayout_Layout_layout_constraintTag, CONSTRAINT_TAG);
            sMapToConstant.append(C0166R.styleable.Layout_guidelineUseRtl, GUIDE_USE_RTL);
        }
    ...
    public static class Transform {
        ...
        static {
            ...
            sMapToConstant.append(C0166R.styleable.Transform_android_rotationX, 2);
            sMapToConstant.append(C0166R.styleable.Transform_android_rotationY, 3);
            sMapToConstant.append(C0166R.styleable.Transform_android_scaleX, 4);
            sMapToConstant.append(C0166R.styleable.Transform_android_scaleY, 5);
            sMapToConstant.append(C0166R.styleable.Transform_android_transformPivotX, 6);
            sMapToConstant.append(C0166R.styleable.Transform_android_transformPivotY, 7);
            sMapToConstant.append(C0166R.styleable.Transform_android_translationX, 8);
            sMapToConstant.append(C0166R.styleable.Transform_android_translationY, 9);
            sMapToConstant.append(C0166R.styleable.Transform_android_translationZ, 10);
            sMapToConstant.append(C0166R.styleable.Transform_android_elevation, 11);
            sMapToConstant.append(C0166R.styleable.Transform_transformPivotTarget, 12);
        }
    ...
    public static class Motion {
        ...
        static {
            ...
            sMapToConstant.append(C0166R.styleable.Motion_pathMotionArc, 2);
            sMapToConstant.append(C0166R.styleable.Motion_transitionEasing, 3);
            sMapToConstant.append(C0166R.styleable.Motion_drawPath, 4);
            sMapToConstant.append(C0166R.styleable.Motion_animateRelativeTo, 5);
            sMapToConstant.append(C0166R.styleable.Motion_animateCircleAngleTo, 6);
            sMapToConstant.append(C0166R.styleable.Motion_motionStagger, 7);
            sMapToConstant.append(C0166R.styleable.Motion_quantizeMotionSteps, 8);
            sMapToConstant.append(C0166R.styleable.Motion_quantizeMotionPhase, 9);
            sMapToConstant.append(C0166R.styleable.Motion_quantizeMotionInterpolator, 10);
        }
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            Constraint constraint = constraintSet.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m1221clone());
            }
        }
    }
    ...
    */
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet, boolean z) {
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, z ? C0166R.styleable.ConstraintOverride : C0166R.styleable.Constraint);
    ...
    public static Constraint buildDelta(Context context, XmlPullParser xmlPullParser) {
        ...
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(asAttributeSet, C0166R.styleable.ConstraintOverride);
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0166R.id.class.getField(trim).getInt(null);
