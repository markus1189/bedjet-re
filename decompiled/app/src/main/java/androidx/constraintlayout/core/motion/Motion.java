...
public class Motion implements TypedValues {
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f6 = this.mStartMotionPath.f21mX + ((this.mEndMotionPath.f21mX - this.mStartMotionPath.f21mX) * f5) + 0.5f;
            float f7 = this.mStartMotionPath.f22mY + ((this.mEndMotionPath.f22mY - this.mStartMotionPath.f22mY) * f5) + 0.5f;
