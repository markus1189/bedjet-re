...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ...
        ShortcutInfo build;
        ComponentDialog$$ExternalSyntheticApiModelOutline0.m63m();
        shortLabel = ComponentDialog$$ExternalSyntheticApiModelOutline0.m17m(this.mContext, this.mId).setShortLabel(this.mLabel);
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, ComponentDialog$$ExternalSyntheticApiModelOutline0.m29m((Object) it.next())).build());
        }
        return arrayList;
    }
