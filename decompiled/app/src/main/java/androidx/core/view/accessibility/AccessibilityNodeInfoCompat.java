...
public class AccessibilityNodeInfoCompat {
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public TouchDelegateInfoCompat(Map<Region, View> map) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mInfo = PrintHelper$$ExternalSyntheticApiModelOutline0.m304m((Map) map);
            } else {
                this.mInfo = null;
            }
        }
        ...
        */
        public androidx.core.view.accessibility.AccessibilityNodeInfoCompat getTargetForRegion(android.graphics.Region r3) {
            /*
                ...
                android.view.accessibility.AccessibilityNodeInfo r3 = androidx.print.PrintHelper$$ExternalSyntheticApiModelOutline0.m305m(r0, r3)
                if (r3 == 0) goto L13
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        if (Build.VERSION.SDK_INT < 26) {
            ...
            getExtras().putInt(SPANS_ACTION_ID_KEY, C0170R.id.accessibility_action_clickable_span);
    ...
    private SparseArray<WeakReference<ClickableSpan>> getOrCreateSpansFromViewTags(View view) {
        ...
        view.setTag(C0170R.id.tag_accessibility_clickable_spans, sparseArray);
        return sparseArray;
    }

    private SparseArray<WeakReference<ClickableSpan>> getSpansFromViewTags(View view) {
        return (SparseArray) view.getTag(C0170R.id.tag_accessibility_clickable_spans);
    }
    ...
    */
    public androidx.core.view.accessibility.AccessibilityNodeInfoCompat.TouchDelegateInfoCompat getTouchDelegateInfo() {
        /*
            ...
            android.view.accessibility.AccessibilityNodeInfo$TouchDelegateInfo r0 = androidx.print.PrintHelper$$ExternalSyntheticApiModelOutline0.m303m(r0)
            if (r0 == 0) goto L14
