...
public class ViewCompat {
    ...
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0170R.id.accessibility_custom_action_0, C0170R.id.accessibility_custom_action_1, C0170R.id.accessibility_custom_action_2, C0170R.id.accessibility_custom_action_3, C0170R.id.accessibility_custom_action_4, C0170R.id.accessibility_custom_action_5, C0170R.id.accessibility_custom_action_6, C0170R.id.accessibility_custom_action_7, C0170R.id.accessibility_custom_action_8, C0170R.id.accessibility_custom_action_9, C0170R.id.accessibility_custom_action_10, C0170R.id.accessibility_custom_action_11, C0170R.id.accessibility_custom_action_12, C0170R.id.accessibility_custom_action_13, C0170R.id.accessibility_custom_action_14, C0170R.id.accessibility_custom_action_15, C0170R.id.accessibility_custom_action_16, C0170R.id.accessibility_custom_action_17, C0170R.id.accessibility_custom_action_18, C0170R.id.accessibility_custom_action_19, C0170R.id.accessibility_custom_action_20, C0170R.id.accessibility_custom_action_21, C0170R.id.accessibility_custom_action_22, C0170R.id.accessibility_custom_action_23, C0170R.id.accessibility_custom_action_24, C0170R.id.accessibility_custom_action_25, C0170R.id.accessibility_custom_action_26, C0170R.id.accessibility_custom_action_27, C0170R.id.accessibility_custom_action_28, C0170R.id.accessibility_custom_action_29, C0170R.id.accessibility_custom_action_30, C0170R.id.accessibility_custom_action_31};
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList arrayList = (ArrayList) view.getTag(C0170R.id.tag_accessibility_actions);
        if (arrayList != null) {
            return arrayList;
        }
        ArrayList arrayList2 = new ArrayList();
        view.setTag(C0170R.id.tag_accessibility_actions, arrayList2);
        return arrayList2;
    }
    ...
    public static void setOnReceiveContentListener(View view, String[] strArr, OnReceiveContentListener onReceiveContentListener) {
        ...
        view.setTag(C0170R.id.tag_on_receive_content_mime_types, strArr);
        view.setTag(C0170R.id.tag_on_receive_content_listener, onReceiveContentListener);
    }
    ...
    public static String[] getOnReceiveContentMimeTypes(View view) {
        ...
        return (String[]) view.getTag(C0170R.id.tag_on_receive_content_mime_types);
    }
    ...
    public static ContentInfoCompat performReceiveContent(View view, ContentInfoCompat contentInfoCompat) {
        ...
        OnReceiveContentListener onReceiveContentListener = (OnReceiveContentListener) view.getTag(C0170R.id.tag_on_receive_content_listener);
        if (onReceiveContentListener != null) {
    ...
    public static void setPointerIcon(View view, PointerIconCompat pointerIconCompat) {
        if (Build.VERSION.SDK_INT >= 24) {
            Api24Impl.setPointerIcon(view, HalfKt$$ExternalSyntheticApiModelOutline0.m230m(pointerIconCompat != null ? pointerIconCompat.getPointerIcon() : null));
        }
    }
    ...
    public static void addOnUnhandledKeyEventListener(View view, OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        ...
        ArrayList arrayList = (ArrayList) view.getTag(C0170R.id.tag_unhandled_key_listeners);
        if (arrayList == null) {
            arrayList = new ArrayList();
            view.setTag(C0170R.id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    public static boolean dispatchUnhandledKeyEventBeforeHierarchy(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m264at(view).preDispatch(keyEvent);
    }
    ...
    public static boolean dispatchUnhandledKeyEventBeforeCallback(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m264at(view).dispatch(view, keyEvent);
    }
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0170R.id.tag_screen_reader_focusable, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.1
            /* JADX INFO: Access modifiers changed from: package-private */
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0170R.id.tag_accessibility_pane_title, CharSequence.class, 8, 28) { // from class: androidx.core.view.ViewCompat.2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
    ...
    private static AccessibilityViewProperty<CharSequence> stateDescriptionProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0170R.id.tag_state_description, CharSequence.class, 64, 30) { // from class: androidx.core.view.ViewCompat.3
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
            public CharSequence frameworkGet(View view) {
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0170R.id.tag_accessibility_heading, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.4
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
            public Boolean frameworkGet(View view) {
    ...
    static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        static UnhandledKeyEventManager m264at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0170R.id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0170R.id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
    ...
    public static class Api21Impl {
        ...
        static void setOnApplyWindowInsetsListener(final View view, final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
            if (Build.VERSION.SDK_INT < 30) {
                view.setTag(C0170R.id.tag_on_apply_window_listener, onApplyWindowInsetsListener);
            }
            if (onApplyWindowInsetsListener == null) {
                view.setOnApplyWindowInsetsListener((View.OnApplyWindowInsetsListener) view.getTag(C0170R.id.tag_window_insets_animation_callback));
            } else {
        ...
        static void callCompatInsetAnimationCallback(WindowInsets windowInsets, View view) {
            View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = (View.OnApplyWindowInsetsListener) view.getTag(C0170R.id.tag_window_insets_animation_callback);
            if (onApplyWindowInsetsListener != null) {
    ...
    public static class Api28Impl {
        ...
        static void addOnUnhandledKeyEventListener(View view, final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
            SimpleArrayMap simpleArrayMap = (SimpleArrayMap) view.getTag(C0170R.id.tag_unhandled_key_listeners);
            if (simpleArrayMap == null) {
                simpleArrayMap = new SimpleArrayMap();
                view.setTag(C0170R.id.tag_unhandled_key_listeners, simpleArrayMap);
            }
