...
class FragmentAnim {
    ...
    public static AnimationOrAnimator loadAnimation(Context context, Fragment fragment, boolean z, boolean z2) {
        ...
        if (fragment.mContainer != null && fragment.mContainer.getTag(C0410R.id.visible_removing_fragment_view_tag) != null) {
            fragment.mContainer.setTag(C0410R.id.visible_removing_fragment_view_tag, null);
        }
    ...
    private static int transitToAnimResourceId(Context context, int i, boolean z) {
        if (i == 4097) {
            return z ? C0410R.animator.fragment_open_enter : C0410R.animator.fragment_open_exit;
        }
        if (i == 8194) {
            return z ? C0410R.animator.fragment_close_enter : C0410R.animator.fragment_close_exit;
        }
        if (i == 8197) {
            if (z) {
        ...
        if (i == 4099) {
            return z ? C0410R.animator.fragment_fade_enter : C0410R.animator.fragment_fade_exit;
        }
        if (i != 4100) {
            return -1;
        }
