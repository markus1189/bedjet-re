...
public class AlertController {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0030R.id.scrollIndicatorUp);
        final View findViewById2 = this.mWindow.findViewById(C0030R.id.scrollIndicatorDown);
