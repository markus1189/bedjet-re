    ...
    */
    public void loadFromAttributes(android.util.AttributeSet r11, int r12) {
        /*
            ...
            int[] r1 = androidx.appcompat.C0030R.styleable.CheckedTextView
            r2 = 0
            ...
            int[] r5 = androidx.appcompat.C0030R.styleable.CheckedTextView
            ...
            int r11 = androidx.appcompat.C0030R.styleable.CheckedTextView_checkMarkCompat     // Catch: java.lang.Throwable -> L8a
            ...
            goto L5a
        L3d:
            int r11 = androidx.appcompat.C0030R.styleable.CheckedTextView_android_checkMark     // Catch: java.lang.Throwable -> L8a
            boolean r11 = r0.hasValue(r11)     // Catch: java.lang.Throwable -> L8a
            if (r11 == 0) goto L5a
            int r11 = androidx.appcompat.C0030R.styleable.CheckedTextView_android_checkMark     // Catch: java.lang.Throwable -> L8a
            int r11 = r0.getResourceId(r11, r2)     // Catch: java.lang.Throwable -> L8a
        ...
        L5a:
            int r11 = androidx.appcompat.C0030R.styleable.CheckedTextView_checkMarkTint     // Catch: java.lang.Throwable -> L8a
            boolean r11 = r0.hasValue(r11)     // Catch: java.lang.Throwable -> L8a
            if (r11 == 0) goto L6d
            android.widget.CheckedTextView r11 = r10.mView     // Catch: java.lang.Throwable -> L8a
            int r12 = androidx.appcompat.C0030R.styleable.CheckedTextView_checkMarkTint     // Catch: java.lang.Throwable -> L8a
        ...
        L6d:
            int r11 = androidx.appcompat.C0030R.styleable.CheckedTextView_checkMarkTintMode     // Catch: java.lang.Throwable -> L8a
            boolean r11 = r0.hasValue(r11)     // Catch: java.lang.Throwable -> L8a
            if (r11 == 0) goto L86
            android.widget.CheckedTextView r11 = r10.mView     // Catch: java.lang.Throwable -> L8a
            int r12 = androidx.appcompat.C0030R.styleable.CheckedTextView_checkMarkTintMode     // Catch: java.lang.Throwable -> L8a
            r1 = -1
